...
nix run nixpkgs#jarvis           # lub github:jaminsmoke/Jarvis dla najnowszej gałęzi dev
```
...
Jarvis jest także dostępny jako aplikacja desktopowa. Pobierz ją bezpośrednio ze strony [releases](https://github.com/jaminsmoke/Jarvis/releases) lub z [jarvis download](https://jaminsmoke.github.io/Jarvis/download).
...
Dowiedz się więcej o [agents](https://jaminsmoke.github.io/Jarvis/docs/agents).

### Dokumentacja

Więcej informacji o konfiguracji Jarvis znajdziesz w [**dokumentacji**](https://jaminsmoke.github.io/Jarvis/docs).
