...
nix run nixpkgs#jarvis           # ou github:jaminsmoke/Jarvis para a branch dev mais recente
```
...
O Jarvis também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/jaminsmoke/Jarvis/releases) ou em [jarvis download](https://jaminsmoke.github.io/Jarvis/download).
