...
const api: ElectronAPI = {
  ...
  wslServers: {
    ...
    installJarvis: (name) => ipcRenderer.invoke("wsl-servers-install-jarvis", name),
  ...
  connector: {
    github: {
      getStatus: () => ipcRenderer.invoke("connector-github-status"),
      setEnabled: (enabled) => ipcRenderer.invoke("connector-github-set-enabled", enabled),
    ...
    google: {
      ...
      setEnabled: (enabled) => ipcRenderer.invoke("connector-google-set-enabled", enabled),
    ...
    microsoft: {
      ...
      setEnabled: (enabled) => ipcRenderer.invoke("connector-microsoft-set-enabled", enabled),
