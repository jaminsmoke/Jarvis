export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za Jarvis",
  ...
  "desktop.menu.ariaLabel": "Jarvis meni",
  ...
  "desktop.recovery.loadFailed": "Jarvis se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor Jarvis-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "Jarvis ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija Jarvis-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.opencodeMissing": "Jarvis nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje Jarvis-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Jarvis-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Jarvis-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Jarvis-u.",
  ...
  "dialog.server.description": "Promijeni na koji se Jarvis server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera Jarvis u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje Jarvis u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj Jarvis u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj Jarvis u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi Jarvis mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "Jarvis nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori Jarvis.",
  ...
  "help.tabs.introduction": "Jarvis Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija Jarvis-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Jarvis timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Jarvis još ne podržava MCP autentifikaciju.',
  ...
  "titlebar.toggleDebugTools": "Uključi/isključi alatke za otklanjanje grešaka",
  ...
  "sidebar.gettingStarted.line1": "Jarvis uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.tab.connectors": "Konektori",
  "settings.integrations.placeholder": "Integracije proširuju Jarvis runtime. Uskoro ćete moći instalirati dodatke, teme i sistemske ekstenzije.",
  "settings.connectors.placeholder": "Konektori povezuju Jarvis s vanjskim uslugama. Uskoro: Gmail, WhatsApp, Slack, Notion, Telegram i još.",
  "settings.connectors.unavailable": "Konektori su dostupni samo u desktop aplikaciji.",
  ...
  "settings.connectors.github.permission.repos": "Čitajte i upravljajte svojim repozitorijima, issue-ima i pull request-ovima",
  "settings.connectors.github.permission.profile": "Čitajte svoj javni profil (korisničko ime i avatar)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "Poveži GitHub",
  "settings.connectors.github.disconnect": "Prekini vezu",
  "settings.connectors.github.cancel": "Otkaži",
  "settings.connectors.github.openBrowser": "Otvori preglednik",
  "settings.connectors.github.waiting": "Čeka se autorizacija…",
  "settings.connectors.github.code.instructions": "Unesite ovaj kod na",
  "settings.connectors.github.connected.text": "Povezano putem OAuth-a. Jarvis može pristupiti vašem GitHub računu.",
  "settings.connectors.github.error.expired": "Kod za autorizaciju je istekao. Pokušajte ponovo.",
  "settings.connectors.github.error.generic": "Nije moguće povezati se s GitHubom. Provjerite vezu i pokušajte ponovo.",
  "settings.connectors.github.error.denied": "Autorizacija odbijena. Možete pokušati ponovo u bilo kojem trenutku.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Povežite svoj Google račun kako bi Jarvis mogao čitati i upravljati vašim Drive dokumentima.",
  "settings.connectors.google.detail": "Povežite svoj Google račun kako bi Jarvis mogao pristupiti vašim Google Drive i Docs dokumentima. Ovlašćujete pristup svojim Google računom putem OAuth-a - Jarvis nikada ne vidi vašu lozinku.",
  "settings.connectors.google.permission.drive": "Čitajte svoje Google Drive datoteke",
  "settings.connectors.google.permission.profile": "Čitajte svoj profil (ime i email)",
  "settings.connectors.google.connect": "Poveži Google",
  "settings.connectors.google.disconnect": "Prekini vezu",
  "settings.connectors.google.cancel": "Otkaži",
  "settings.connectors.google.openBrowser": "Otvori preglednik",
  "settings.connectors.google.waiting": "Čeka se autorizacija…",
  "settings.connectors.google.code.instructions": "Unesite ovaj kod na",
  "settings.connectors.google.connected.text": "Povezano putem OAuth-a. Jarvis može pristupiti vašem Google računu.",
  "settings.connectors.google.error.expired": "Kod za autorizaciju je istekao. Pokušajte ponovo.",
  "settings.connectors.google.error.generic": "Nije moguće povezati se s Googleom. Provjerite vezu i pokušajte ponovo.",
  "settings.connectors.google.error.denied": "Autorizacija odbijena. Možete pokušati ponovo u bilo kojem trenutku.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Povežite svoj Microsoft račun kako bi Jarvis mogao pristupiti OneDrive, pošti i vašem profilu.",
  "settings.connectors.microsoft.detail": "Povežite svoj Microsoft račun kako bi Jarvis mogao pristupiti vašim OneDrive datotekama i profilu. Ovlašćujete pristup svojim Microsoft računom putem OAuth-a - Jarvis nikada ne vidi vašu lozinku.",
  "settings.connectors.microsoft.permission.files": "Čitajte svoje OneDrive datoteke",
  "settings.connectors.microsoft.permission.profile": "Čitajte svoj profil (ime i email)",
  "settings.connectors.microsoft.connect": "Poveži Microsoft",
  "settings.connectors.microsoft.disconnect": "Prekini vezu",
  "settings.connectors.microsoft.cancel": "Otkaži",
  "settings.connectors.microsoft.openBrowser": "Otvori preglednik",
  "settings.connectors.microsoft.waiting": "Čeka se autorizacija…",
  "settings.connectors.microsoft.code.instructions": "Unesite ovaj kod na",
  "settings.connectors.microsoft.connected.text": "Povezano putem OAuth-a. Jarvis može pristupiti vašem Microsoft računu.",
  "settings.connectors.microsoft.error.expired": "Kod za autorizaciju je istekao. Pokušajte ponovo.",
  "settings.connectors.microsoft.error.generic": "Nije moguće povezati se s Microsoftom. Provjerite vezu i pokušajte ponovo.",
  "settings.connectors.microsoft.error.denied": "Autorizacija odbijena. Možete pokušati ponovo u bilo kojem trenutku.",
  ...
  "settings.desktop.wsl.description": "Pokreni Jarvis server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Jarvis-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako Jarvis izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li Jarvis prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Jarvis-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Jarvis pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Jarvis-a.",
  ...
  "dialog.usageExceeded.dontShowAgain": "Ne prikazuj ponovo",
