...
export const dict = {
  ...
  "desktop.menu.documentation": "Jarvis-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "Jarvis-meny",
  ...
  "desktop.recovery.loadFailed": "Jarvis kunne ikke lastes inn",
  "desktop.recovery.terminated": "Jarvis-vinduet ble uventet avsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av Jarvis mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.opencodeMissing": "Jarvis er ikke installert i denne distribusjonen",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis er installert, men kunne ikke kjøres",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av Jarvis er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Jarvis",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i Jarvis.",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Jarvis.",
  ...
  "dialog.server.description": "Bytt hvilken Jarvis-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Jarvis ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Jarvis-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Jarvis ikke støtter MCP-autentisering ennå.',
  ...
  "titlebar.toggleDebugTools": "Vis eller skjul feilsøkingsverktøy",
  ...
  "sidebar.gettingStarted.line1": "Jarvis inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.tab.integrations": "Integrasjoner",
  "settings.tab.connectors": "Koblinger",
  "settings.integrations.placeholder": "Integrasjoner utvider Jarvis-kjøretiden. Snart kan du installere plugins, temaer og systemutvidelser.",
  "settings.connectors.placeholder": "Koblinger forbinder Jarvis med eksterne tjenester. Kommer snart: Gmail, WhatsApp, Slack, Notion, Telegram og mer.",
  "settings.connectors.unavailable": "Koblinger er kun tilgjengelige i skrivebordsappen.",
  ...
  "settings.connectors.github.permission.repos": "Lese og administrere repositoriene, issues og pull requests dine",
  "settings.connectors.github.permission.profile": "Lese den offentlige profilen din (brukernavn og avatar)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "Koble til GitHub",
  "settings.connectors.github.disconnect": "Koble fra",
  "settings.connectors.github.cancel": "Avbryt",
  "settings.connectors.github.openBrowser": "Åpne nettleser",
  "settings.connectors.github.waiting": "Venter på autorisasjon…",
  "settings.connectors.github.code.instructions": "Skriv inn denne koden på",
  "settings.connectors.github.connected.text": "Tilkoblet via OAuth. Jarvis kan få tilgang til GitHub-kontoen din.",
  "settings.connectors.github.error.expired": "Autorisasjonskoden er utløpt. Prøv igjen.",
  "settings.connectors.github.error.generic": "Kunne ikke koble til GitHub. Sjekk tilkoblingen og prøv igjen.",
  "settings.connectors.github.error.denied": "Autorisasjon avvist. Du kan prøve igjen når du vil.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Koble til Google-kontoen din slik at Jarvis kan lese og administrere Drive-dokumentene dine.",
  "settings.connectors.google.detail": "Koble til Google-kontoen din slik at Jarvis kan få tilgang til Google Drive og Docs. Du autoriserer tilgang med din egen Google-konto via OAuth - Jarvis ser aldri passordet ditt.",
  "settings.connectors.google.permission.drive": "Lese Google Drive-filene dine",
  "settings.connectors.google.permission.profile": "Lese profilen din (navn og e-post)",
  "settings.connectors.google.connect": "Koble til Google",
  "settings.connectors.google.disconnect": "Koble fra",
  "settings.connectors.google.cancel": "Avbryt",
  "settings.connectors.google.openBrowser": "Åpne nettleser",
  "settings.connectors.google.waiting": "Venter på autorisasjon…",
  "settings.connectors.google.code.instructions": "Skriv inn denne koden på",
  "settings.connectors.google.connected.text": "Tilkoblet via OAuth. Jarvis kan få tilgang til Google-kontoen din.",
  "settings.connectors.google.error.expired": "Autorisasjonskoden er utløpt. Prøv igjen.",
  "settings.connectors.google.error.generic": "Kunne ikke koble til Google. Sjekk tilkoblingen og prøv igjen.",
  "settings.connectors.google.error.denied": "Autorisasjon avvist. Du kan prøve igjen når du vil.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Koble til Microsoft-kontoen din slik at Jarvis kan få tilgang til OneDrive, e-post og profilen din.",
  "settings.connectors.microsoft.detail": "Koble til Microsoft-kontoen din slik at Jarvis kan få tilgang til OneDrive-filene og profilen din. Du autoriserer tilgang med din egen Microsoft-konto via OAuth - Jarvis ser aldri passordet ditt.",
  "settings.connectors.microsoft.permission.files": "Lese OneDrive-filene dine",
  "settings.connectors.microsoft.permission.profile": "Lese profilen din (navn og e-post)",
  "settings.connectors.microsoft.connect": "Koble til Microsoft",
  "settings.connectors.microsoft.disconnect": "Koble fra",
  "settings.connectors.microsoft.cancel": "Avbryt",
  "settings.connectors.microsoft.openBrowser": "Åpne nettleser",
  "settings.connectors.microsoft.waiting": "Venter på autorisasjon…",
  "settings.connectors.microsoft.code.instructions": "Skriv inn denne koden på",
  "settings.connectors.microsoft.connected.text": "Tilkoblet via OAuth. Jarvis kan få tilgang til Microsoft-kontoen din.",
  "settings.connectors.microsoft.error.expired": "Autorisasjonskoden er utløpt. Prøv igjen.",
  "settings.connectors.microsoft.error.generic": "Kunne ikke koble til Microsoft. Sjekk tilkoblingen og prøv igjen.",
  "settings.connectors.microsoft.error.denied": "Autorisasjon avvist. Du kan prøve igjen når du vil.",
  "desktop.menu.wiki": "Wiki",
  "command.session.export": "Eksporter økt",
  "command.session.export.description": "Eksporter hele økttranskripsjonen som JSON",
  "context.export.session": "Eksporter økt",
  "toast.session.export.success.title": "Økt eksportert",
  "toast.session.export.success.description": "Økt lagret i {{filename}}",
  "toast.session.export.failed.title": "Kunne ikke eksportere økt",
  "toast.session.export.failed.description": "Det oppstod en feil under eksportering av økten",
  "common.export": "Eksporter",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL-integrasjon",
  "settings.desktop.wsl.description": "Kjør Jarvis-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Jarvis",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Jarvis ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om Jarvis skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i Jarvis.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Jarvis starter",
  ...
  "settings.updates.toast.latest.title": "Jarvis er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Jarvis.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker Jarvis i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer Jarvis i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater Jarvis i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før Jarvis kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "Jarvis kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter Jarvis på nytt.",
  ...
  "help.tabs.introduction": "Jarvis Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
