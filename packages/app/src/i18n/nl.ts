export const dict = {
  ...
  "desktop.menu.documentation": "Jarvis-documentatie",
  ...
  "desktop.recovery.loadFailed": "Jarvis kan niet worden geladen",
  "desktop.recovery.terminated": "Het Jarvis-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "Jarvis reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van Jarvis is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.opencodeMissing": "Jarvis is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De Jarvis-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door Jarvis",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in Jarvis te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in Jarvis te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in Jarvis te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke Jarvis-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "Jarvis controleren...",
  "wsl.onboarding.checkingOpencodeIn": "Jarvis controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Jarvis bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "Jarvis bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk Jarvis bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Jarvis bijwerken",
  "wsl.onboarding.opencodeReadyIn": "Jarvis is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer Jarvis in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat Jarvis een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "Jarvis kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens Jarvis opnieuw.",
  ...
  "help.tabs.introduction": "Jarvis Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "dialog.usageExceeded.dontShowAgain": "Niet opnieuw tonen",
  ...
  "toast.update.description": "Er is nu een nieuwe versie van Jarvis ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het Jarvis-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: Jarvis ondersteunt nog geen MCP-authenticatie.',
  ...
  "titlebar.toggleDebugTools": "Debugtools tonen of verbergen",
  ...
  "sidebar.gettingStarted.line1": "Jarvis bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.integrations.placeholder": "Integraties breiden de Jarvis-runtime uit. Binnenkort kun je plug-ins, thema's en systeemextensies installeren.",
  "settings.connectors.placeholder": "Connectors verbinden Jarvis met externe services. Binnenkort: Gmail, WhatsApp, Slack, Notion, Telegram en meer.",
  "settings.connectors.unavailable": "Connectors zijn alleen beschikbaar in de desktop-app.",
  "settings.connectors.badge.connected": "Verbonden",
  "settings.connectors.badge.notConnected": "Niet verbonden",
  "settings.connectors.badge.disabled": "Uitgeschakeld",
  ...
  "settings.connectors.github.summary": "Verbind je GitHub-account zodat Jarvis je repositories kan lezen en beheren.",
  "settings.connectors.github.detail": "Verbind je GitHub-account zodat Jarvis rechtstreeks vanuit de chat met je repositories, issues en pull requests kan werken. Je autoriseert toegang met je GitHub-account via OAuth — Jarvis ziet je wachtwoord nooit.",
  "settings.connectors.github.permission.repos": "Je repositories, issues en pull requests lezen en beheren",
  "settings.connectors.github.permission.profile": "Je openbare profiel lezen (gebruikersnaam en avatar)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "GitHub verbinden",
  "settings.connectors.github.disconnect": "Verbinding verbreken",
  "settings.connectors.github.cancel": "Annuleren",
  "settings.connectors.github.openBrowser": "Browser openen",
  "settings.connectors.github.waiting": "Wachten op autorisatie…",
  "settings.connectors.github.code.instructions": "Voer deze code in op",
  "settings.connectors.github.connected.text": "Verbonden via OAuth. Jarvis heeft toegang tot je GitHub-account.",
  "settings.connectors.github.error.expired": "De autorisatiecode is verlopen. Probeer het opnieuw.",
  "settings.connectors.github.error.generic": "Kan geen verbinding maken met GitHub. Controleer je verbinding en probeer het opnieuw.",
  "settings.connectors.github.error.denied": "Autorisatie geweigerd. Je kunt het op elk moment opnieuw proberen.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Verbind je Google-account zodat Jarvis je Drive-documenten kan lezen en beheren.",
  "settings.connectors.google.detail": "Verbind je Google-account zodat Jarvis toegang heeft tot je Google Drive en Docs. Je autoriseert toegang met je Google-account via OAuth - Jarvis ziet je wachtwoord nooit.",
  "settings.connectors.google.permission.drive": "Je Google Drive-bestanden lezen",
  "settings.connectors.google.permission.profile": "Je profiel lezen (naam en e-mailadres)",
  "settings.connectors.google.connect": "Google verbinden",
  "settings.connectors.google.disconnect": "Verbinding verbreken",
  "settings.connectors.google.cancel": "Annuleren",
  "settings.connectors.google.openBrowser": "Browser openen",
  "settings.connectors.google.waiting": "Wachten op autorisatie…",
  "settings.connectors.google.code.instructions": "Voer deze code in op",
  "settings.connectors.google.connected.text": "Verbonden via OAuth. Jarvis heeft toegang tot je Google-account.",
  "settings.connectors.google.error.expired": "De autorisatiecode is verlopen. Probeer het opnieuw.",
  "settings.connectors.google.error.generic": "Kan geen verbinding maken met Google. Controleer je verbinding en probeer het opnieuw.",
  "settings.connectors.google.error.denied": "Autorisatie geweigerd. Je kunt het op elk moment opnieuw proberen.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Verbind je Microsoft-account zodat Jarvis toegang heeft tot OneDrive, e-mail en je profiel.",
  "settings.connectors.microsoft.detail": "Verbind je Microsoft-account zodat Jarvis toegang heeft tot je OneDrive-bestanden en profiel. Je autoriseert toegang met je Microsoft-account via OAuth - Jarvis ziet je wachtwoord nooit.",
  "settings.connectors.microsoft.permission.files": "Je OneDrive-bestanden lezen",
  "settings.connectors.microsoft.permission.profile": "Je profiel lezen (naam en e-mailadres)",
  "settings.connectors.microsoft.connect": "Microsoft verbinden",
  "settings.connectors.microsoft.disconnect": "Verbinding verbreken",
  "settings.connectors.microsoft.cancel": "Annuleren",
  "settings.connectors.microsoft.openBrowser": "Browser openen",
  "settings.connectors.microsoft.waiting": "Wachten op autorisatie…",
  "settings.connectors.microsoft.code.instructions": "Voer deze code in op",
  "settings.connectors.microsoft.connected.text": "Verbonden via OAuth. Jarvis heeft toegang tot je Microsoft-account.",
  "settings.connectors.microsoft.error.expired": "De autorisatiecode is verlopen. Probeer het opnieuw.",
  "settings.connectors.microsoft.error.generic": "Kan geen verbinding maken met Microsoft. Controleer je verbinding en probeer het opnieuw.",
  "settings.connectors.microsoft.error.denied": "Autorisatie geweigerd. Je kunt het op elk moment opnieuw proberen.",
  ...
  "settings.desktop.wsl.description": "Voer de Jarvis-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor Jarvis",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe Jarvis eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of Jarvis het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van Jarvis aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer Jarvis wordt gestart",
  ...
  "settings.updates.toast.latest.title": "Jarvis is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van Jarvis.",
