export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "Jarvis n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis est installé, mais n'a pas pu s'exécuter",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Jarvis",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
...
"settings.connectors.github.connect": "Connecter GitHub",
  ...
  "settings.connectors.google.summary": "Connectez votre compte Google pour que Jarvis puisse lire et gérer vos documents Drive.",
  "settings.connectors.google.detail": "Connectez votre compte Google pour que Jarvis puisse accéder à vos documents Google Drive et Docs. Vous autorisez l'accès avec votre propre compte Google via OAuth - Jarvis ne voit jamais votre mot de passe.",
  "settings.connectors.google.permission.drive": "Lire vos fichiers Google Drive",
  "settings.connectors.google.permission.profile": "Lire votre profil (nom et e-mail)",
  "settings.connectors.google.connect": "Connecter Google",
  "settings.connectors.google.disconnect": "Déconnecter",
  "settings.connectors.google.cancel": "Annuler",
  "settings.connectors.google.openBrowser": "Ouvrir le navigateur",
  "settings.connectors.google.waiting": "En attente d'autorisation…",
  "settings.connectors.google.code.instructions": "Saisissez ce code sur",
  "settings.connectors.google.connected.text": "Connecté via OAuth. Jarvis peut accéder à votre compte Google.",
  "settings.connectors.google.error.expired": "Le code d'autorisation a expiré. Veuillez réessayer.",
  "settings.connectors.google.error.generic": "Impossible de se connecter à Google. Vérifiez votre connexion et réessayez.",
  "settings.connectors.google.error.denied": "Autorisation refusée. Vous pouvez réessayer à tout moment.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Connectez votre compte Microsoft pour que Jarvis puisse accéder à OneDrive, à vos e-mails et à votre profil.",
  "settings.connectors.microsoft.detail": "Connectez votre compte Microsoft pour que Jarvis puisse accéder à vos fichiers OneDrive et à votre profil. Vous autorisez l'accès avec votre propre compte Microsoft via OAuth - Jarvis ne voit jamais votre mot de passe.",
  "settings.connectors.microsoft.permission.files": "Lire vos fichiers OneDrive",
  "settings.connectors.microsoft.permission.profile": "Lire votre profil (nom et e-mail)",
  "settings.connectors.microsoft.connect": "Connecter Microsoft",
  "settings.connectors.microsoft.disconnect": "Déconnecter",
  "settings.connectors.microsoft.cancel": "Annuler",
  "settings.connectors.microsoft.openBrowser": "Ouvrir le navigateur",
  "settings.connectors.microsoft.waiting": "En attente d'autorisation…",
  "settings.connectors.microsoft.code.instructions": "Saisissez ce code sur",
  "settings.connectors.microsoft.connected.text": "Connecté via OAuth. Jarvis peut accéder à votre compte Microsoft.",
  "settings.connectors.microsoft.error.expired": "Le code d'autorisation a expiré. Veuillez réessayer.",
  "settings.connectors.microsoft.error.generic": "Impossible de se connecter à Microsoft. Vérifiez votre connexion et réessayez.",
  "settings.connectors.microsoft.error.denied": "Autorisation refusée. Vous pouvez réessayer à tout moment.",
