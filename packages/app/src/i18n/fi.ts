export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Jarvisssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja Jarvisssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja Jarvisssa.",
  ...
  "dialog.server.description": "Vaihda Jarvis-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan Jarvisa...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan Jarvisa kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään Jarvisa...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään Jarvisa kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä Jarvis jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna Jarvis jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvisa ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin Jarvis voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "Jarvis ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten Jarvis uudelleen.",
  ...
  "toast.update.description": "Jarvisn uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä Jarvis-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että Jarvis ei vielä tue MCP-todennusta.',
  ...
  "titlebar.toggleDebugTools": "Näytä tai piilota virheenjäljitystyökalut",
  ...
  "sidebar.gettingStarted.line1": "Jarvis sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.tab.integrations": "Integraatiot",
  "settings.tab.connectors": "Liittimet",
  "settings.integrations.placeholder": "Integraatiot laajentavat Jarvis-ajoympäristöä. Pian voit asentaa liitännäisiä, teemoja ja järjestelmälaajennuksia.",
  "settings.connectors.placeholder": "Liittimet yhdistävät Jarvisin ulkoisiin palveluihin. Tulossa pian: Gmail, WhatsApp, Slack, Notion, Telegram ja muita.",
  "settings.connectors.unavailable": "Liittimet ovat saatavilla vain työpöytäsovelluksessa.",
  ...
  "settings.connectors.github.permission.repos": "Lue ja hallinnoi säilöjäsi, issueita ja pull requesteja",
  "settings.connectors.github.permission.profile": "Lue julkinen profiilisi (käyttäjänimi ja avatar)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "Yhdistä GitHub",
  "settings.connectors.github.disconnect": "Katkaise yhteys",
  "settings.connectors.github.cancel": "Peruuta",
  "settings.connectors.github.openBrowser": "Avaa selain",
  "settings.connectors.github.waiting": "Odotetaan valtuutusta…",
  "settings.connectors.github.code.instructions": "Anna tämä koodi osoitteessa",
  "settings.connectors.github.connected.text": "Yhdistetty OAuthin kautta. Jarvis voi käyttää GitHub-tiliäsi.",
  "settings.connectors.github.error.expired": "Valtuutuskoodi on vanhentunut. Yritä uudelleen.",
  "settings.connectors.github.error.generic": "GitHubiin ei voitu yhdistää. Tarkista yhteys ja yritä uudelleen.",
  "settings.connectors.github.error.denied": "Valtuutus evätty. Voit yrittää uudelleen milloin tahansa.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Yhdistä Google-tilisi, jotta Jarvis voi lukea ja hallita Drive-asiakirjojasi.",
  "settings.connectors.google.detail": "Yhdistä Google-tilisi, jotta Jarvis voi käyttää Google Drivea ja Docsia. Annat pääsyn omalla Google-tililläsi OAuthin kautta - Jarvis ei koskaan näe salasanaasi.",
  "settings.connectors.google.permission.drive": "Lue Google Drive -tiedostojasi",
  "settings.connectors.google.permission.profile": "Lue profiilisi (nimi ja sähköposti)",
  "settings.connectors.google.connect": "Yhdistä Google",
  "settings.connectors.google.disconnect": "Katkaise yhteys",
  "settings.connectors.google.cancel": "Peruuta",
  "settings.connectors.google.openBrowser": "Avaa selain",
  "settings.connectors.google.waiting": "Odotetaan valtuutusta…",
  "settings.connectors.google.code.instructions": "Anna tämä koodi osoitteessa",
  "settings.connectors.google.connected.text": "Yhdistetty OAuthin kautta. Jarvis voi käyttää Google-tiliäsi.",
  "settings.connectors.google.error.expired": "Valtuutuskoodi on vanhentunut. Yritä uudelleen.",
  "settings.connectors.google.error.generic": "Googleen ei voitu yhdistää. Tarkista yhteys ja yritä uudelleen.",
  "settings.connectors.google.error.denied": "Valtuutus evätty. Voit yrittää uudelleen milloin tahansa.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Yhdistä Microsoft-tilisi, jotta Jarvis voi käyttää OneDrivea, sähköpostia ja profiiliasi.",
  "settings.connectors.microsoft.detail": "Yhdistä Microsoft-tilisi, jotta Jarvis voi käyttää OneDrive-tiedostojasi ja profiiliasi. Annat pääsyn omalla Microsoft-tililläsi OAuthin kautta - Jarvis ei koskaan näe salasanaasi.",
  "settings.connectors.microsoft.permission.files": "Lue OneDrive-tiedostojasi",
  "settings.connectors.microsoft.permission.profile": "Lue profiilisi (nimi ja sähköposti)",
  "settings.connectors.microsoft.connect": "Yhdistä Microsoft",
  "settings.connectors.microsoft.disconnect": "Katkaise yhteys",
  "settings.connectors.microsoft.cancel": "Peruuta",
  "settings.connectors.microsoft.openBrowser": "Avaa selain",
  "settings.connectors.microsoft.waiting": "Odotetaan valtuutusta…",
  "settings.connectors.microsoft.code.instructions": "Anna tämä koodi osoitteessa",
  "settings.connectors.microsoft.connected.text": "Yhdistetty OAuthin kautta. Jarvis voi käyttää Microsoft-tiliäsi.",
  "settings.connectors.microsoft.error.expired": "Valtuutuskoodi on vanhentunut. Yritä uudelleen.",
  "settings.connectors.microsoft.error.generic": "Microsoftiin ei voitu yhdistää. Tarkista yhteys ja yritä uudelleen.",
  "settings.connectors.microsoft.error.denied": "Valtuutus evätty. Voit yrittää uudelleen milloin tahansa.",
  "desktop.menu.wiki": "Wiki",
  "command.session.export": "Vie istunto",
  "command.session.export.description": "Vie koko istunnon tallenne JSON-muodossa",
  "context.export.session": "Vie istunto",
  "toast.session.export.success.title": "Istunto viety",
  "toast.session.export.success.description": "Istunto tallennettu kohteeseen {{filename}}",
  ...
  "settings.desktop.wsl.description": "Suorita Jarvis-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda Jarvisn näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä Jarvis näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö Jarvis järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta Jarvisn teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun Jarvis käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät Jarvisn uusinta versiota.",
  ...
  "desktop.menu.documentation": "Jarvis-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "Jarvis-valikko",
  ...
  "desktop.recovery.loadFailed": "Jarvisn lataaminen epäonnistui",
  "desktop.recovery.terminated": "Jarvis-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "Jarvis ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "Jarvisn asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.opencodeMissing": "Jarvisa ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvisa ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Jarvisn päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "Jarvis Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
