export const dict = {
  ...
  "desktop.menu.documentation": "Документация Jarvis",
  ...
  "desktop.menu.ariaLabel": "Меню Jarvis",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить Jarvis",
  "desktop.recovery.terminated": "Окно Jarvis неожиданно завершило работу",
  "desktop.recovery.unresponsive": "Jarvis не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить Jarvis",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.opencodeMissing": "Jarvis не установлен в этом дистрибутиве",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis установлен, но его не удалось запустить",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление Jarvis завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в Jarvis.",
  ...
  "dialog.server.description": "Выберите сервер Jarvis, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка Jarvis в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление Jarvis в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите Jarvis в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "Jarvis готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите Jarvis в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в Jarvis требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "Jarvis не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте Jarvis.",
  ...
  "help.tabs.introduction": "Теперь работа в Jarvis Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия Jarvis ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде Jarvis",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: Jarvis пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.integrations.placeholder": "Интеграции расширяют среду выполнения Jarvis. Скоро вы сможете устанавливать плагины, темы и системные расширения.",
  "settings.connectors.placeholder": "Коннекторы связывают Jarvis с внешними сервисами. Скоро: Gmail, WhatsApp, Slack, Notion, Telegram и другие.",
  "settings.connectors.unavailable": "Коннекторы доступны только в настольном приложении.",
  "settings.connectors.badge.connected": "Подключено",
  "settings.connectors.badge.notConnected": "Не подключено",
  "settings.connectors.badge.disabled": "Отключено",
  ...
  "settings.connectors.github.summary": "Подключите аккаунт GitHub, чтобы Jarvis мог читать и управлять вашими репозиториями.",
  "settings.connectors.github.detail": "Подключите аккаунт GitHub, чтобы Jarvis мог работать с вашими репозиториями, issues и pull request прямо из чата. Вы предоставляете доступ через свой аккаунт GitHub по OAuth — Jarvis никогда не видит ваш пароль.",
  "settings.connectors.github.permission.repos": "Чтение и управление вашими репозиториями, issues и pull request",
  "settings.connectors.github.permission.profile": "Чтение вашего публичного профиля (имя пользователя и аватар)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "Подключить GitHub",
  "settings.connectors.github.disconnect": "Отключить",
  "settings.connectors.github.cancel": "Отмена",
  "settings.connectors.github.openBrowser": "Открыть браузер",
  "settings.connectors.github.waiting": "Ожидание авторизации…",
  "settings.connectors.github.code.instructions": "Введите этот код на",
  "settings.connectors.github.connected.text": "Подключено через OAuth. Jarvis может получить доступ к вашему аккаунту GitHub.",
  "settings.connectors.github.error.expired": "Срок действия кода авторизации истёк. Попробуйте ещё раз.",
  "settings.connectors.github.error.generic": "Не удалось подключиться к GitHub. Проверьте соединение и попробуйте снова.",
  "settings.connectors.github.error.denied": "В доступе отказано. Вы можете попробовать снова в любое время.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Подключите аккаунт Google, чтобы Jarvis мог читать и управлять вашими документами в Drive.",
  "settings.connectors.google.detail": "Подключите аккаунт Google, чтобы Jarvis мог получить доступ к вашим документам Google Drive и Docs. Вы предоставляете доступ через свой аккаунт Google по OAuth - Jarvis никогда не видит ваш пароль.",
  "settings.connectors.google.permission.drive": "Чтение ваших файлов в Google Drive",
  "settings.connectors.google.permission.profile": "Чтение вашего профиля (имя и адрес электронной почты)",
  "settings.connectors.google.connect": "Подключить Google",
  "settings.connectors.google.disconnect": "Отключить",
  "settings.connectors.google.cancel": "Отмена",
  "settings.connectors.google.openBrowser": "Открыть браузер",
  "settings.connectors.google.waiting": "Ожидание авторизации…",
  "settings.connectors.google.code.instructions": "Введите этот код на",
  "settings.connectors.google.connected.text": "Подключено через OAuth. Jarvis может получить доступ к вашему аккаунту Google.",
  "settings.connectors.google.error.expired": "Срок действия кода авторизации истёк. Попробуйте ещё раз.",
  "settings.connectors.google.error.generic": "Не удалось подключиться к Google. Проверьте соединение и попробуйте снова.",
  "settings.connectors.google.error.denied": "В доступе отказано. Вы можете попробовать снова в любое время.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Подключите аккаунт Microsoft, чтобы Jarvis мог получить доступ к OneDrive, почте и вашему профилю.",
  "settings.connectors.microsoft.detail": "Подключите аккаунт Microsoft, чтобы Jarvis мог получить доступ к вашим файлам в OneDrive и профилю. Вы предоставляете доступ через свой аккаунт Microsoft по OAuth - Jarvis никогда не видит ваш пароль.",
  "settings.connectors.microsoft.permission.files": "Чтение ваших файлов в OneDrive",
  "settings.connectors.microsoft.permission.profile": "Чтение вашего профиля (имя и адрес электронной почты)",
  "settings.connectors.microsoft.connect": "Подключить Microsoft",
  "settings.connectors.microsoft.disconnect": "Отключить",
  "settings.connectors.microsoft.cancel": "Отмена",
  "settings.connectors.microsoft.openBrowser": "Открыть браузер",
  "settings.connectors.microsoft.waiting": "Ожидание авторизации…",
  "settings.connectors.microsoft.code.instructions": "Введите этот код на",
  "settings.connectors.microsoft.connected.text": "Подключено через OAuth. Jarvis может получить доступ к вашему аккаунту Microsoft.",
  "settings.connectors.microsoft.error.expired": "Срок действия кода авторизации истёк. Попробуйте ещё раз.",
  "settings.connectors.microsoft.error.generic": "Не удалось подключиться к Microsoft. Проверьте соединение и попробуйте снова.",
  "settings.connectors.microsoft.error.denied": "В доступе отказано. Вы можете попробовать снова в любое время.",
  "desktop.menu.wiki": "Вики",
  "command.session.export": "Экспорт сессии",
  "command.session.export.description": "Экспортировать полную запись сессии в формате JSON",
  "context.export.session": "Экспорт сессии",
  ...
  "settings.desktop.wsl.description": "Запускать сервер Jarvis внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения Jarvis",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид Jarvis на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли Jarvis системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление Jarvis.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске Jarvis",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию Jarvis.",
  ...
  "dialog.usageExceeded.dontShowAgain": "Не показывать снова",
