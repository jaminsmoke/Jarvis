...
export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "此發行版中未安裝 Jarvis",
  "desktop.wsl.error.opencodeCannotRun": "已安裝 Jarvis，但無法執行",
...
"settings.connectors.github.connect": "連線 GitHub",
  ...
  "settings.connectors.google.summary": "連線你的 Google 帳戶，讓 Jarvis 讀取和管理你的 Drive 文件。",
  "settings.connectors.google.detail": "連線你的 Google 帳戶，讓 Jarvis 存取你的 Google Drive 和 Docs。你透過 OAuth 使用自己的 Google 帳戶授權存取 - Jarvis 絕不會看到你的密碼。",
  "settings.connectors.google.permission.drive": "讀取你的 Google Drive 文件",
  "settings.connectors.google.permission.profile": "讀取你的資料（姓名和電子郵件）",
  "settings.connectors.google.connect": "連線 Google",
  "settings.connectors.google.disconnect": "中斷連線",
  "settings.connectors.google.cancel": "取消",
  "settings.connectors.google.openBrowser": "開啟瀏覽器",
  "settings.connectors.google.waiting": "等待授權…",
  "settings.connectors.google.code.instructions": "在以下位置輸入此代碼",
  "settings.connectors.google.connected.text": "已透過 OAuth 連線。Jarvis 可以存取你的 Google 帳戶。",
  "settings.connectors.google.error.expired": "授權代碼已過期，請重試。",
  "settings.connectors.google.error.generic": "無法連線到 Google。請檢查連線後重試。",
  "settings.connectors.google.error.denied": "授權已遭拒絕。你可以隨時重試。",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "連線你的 Microsoft 帳戶，讓 Jarvis 存取 OneDrive、郵件和你的資料。",
  "settings.connectors.microsoft.detail": "連線你的 Microsoft 帳戶，讓 Jarvis 存取你的 OneDrive 檔案和資料。你透過 OAuth 使用自己的 Microsoft 帳戶授權存取 - Jarvis 絕不會看到你的密碼。",
  "settings.connectors.microsoft.permission.files": "讀取你的 OneDrive 檔案",
  "settings.connectors.microsoft.permission.profile": "讀取你的資料（姓名和電子郵件）",
  "settings.connectors.microsoft.connect": "連線 Microsoft",
  "settings.connectors.microsoft.disconnect": "中斷連線",
  "settings.connectors.microsoft.cancel": "取消",
  "settings.connectors.microsoft.openBrowser": "開啟瀏覽器",
  "settings.connectors.microsoft.waiting": "等待授權…",
  "settings.connectors.microsoft.code.instructions": "在以下位置輸入此代碼",
  "settings.connectors.microsoft.connected.text": "已透過 OAuth 連線。Jarvis 可以存取你的 Microsoft 帳戶。",
  "settings.connectors.microsoft.error.expired": "授權代碼已過期，請重試。",
  "settings.connectors.microsoft.error.generic": "無法連線到 Microsoft。請檢查連線後重試。",
  "settings.connectors.microsoft.error.denied": "授權已遭拒絕。你可以隨時重試。",
