...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Jarvis 載入失敗",
  "desktop.recovery.terminated": "Jarvis 視窗意外終止",
  "desktop.recovery.unresponsive": "Jarvis 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "Jarvis 安裝失敗",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 Jarvis",
  "desktop.wsl.error.updateVersion":
    "Jarvis 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Jarvis 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 Jarvis 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "Jarvis Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 Jarvis 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 Jarvis 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 Jarvis 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 Jarvis...",
  "wsl.onboarding.updatingOpencode": "正在更新 Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 Jarvis...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 Jarvis。",
  "wsl.onboarding.updateOpencode": "更新 Jarvis",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Jarvis 已就緒。",
  "wsl.onboarding.opencodeReady": "Jarvis 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 Jarvis。",
  "wsl.onboarding.installOpencode": "安裝 Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 Jarvis",
  ...
  "wsl.onboarding.wslUnavailable.description": "Jarvis 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 Jarvis。",
  ...
  "help.tabs.introduction": "Jarvis Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Jarvis 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 Jarvis 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：Jarvis 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "Jarvis 提供免費模型，你可以立即開始使用。",
  ...
  "settings.tab.connectors": "連接器",
  "settings.integrations.placeholder": "整合功能可擴充 Jarvis 執行階段。很快就可安裝外掛、主題和系統擴充功能。",
  "settings.connectors.placeholder": "連接器將 Jarvis 與外部服務連線。即將推出：Gmail、WhatsApp、Slack、Notion、Telegram 等。",
  "settings.connectors.unavailable": "連接器僅在桌面應用程式中提供。",
  "settings.connectors.badge.connected": "已連線",
  "settings.connectors.badge.notConnected": "未連線",
  "settings.connectors.badge.disabled": "已停用",
  "settings.connectors.badge.comingSoon": "Coming soon",
  "settings.connectors.github.name": "GitHub",
  "settings.connectors.github.summary": "連線你的 GitHub 帳戶，讓 Jarvis 讀取和管理你的存放庫。",
  "settings.connectors.github.detail": "連線你的 GitHub 帳戶，讓 Jarvis 直接在聊天中處理你的存放庫、問題和提取要求。你透過 OAuth 使用自己的 GitHub 帳戶授權存取——Jarvis 絕不會看到你的密碼。",
  "settings.connectors.github.permission.repos": "讀取和管理你的存放庫、問題和提取要求",
  "settings.connectors.github.permission.profile": "讀取你的公開資料（使用者名稱和頭像）",
  "settings.connectors.github.connect": "連線 GitHub",
  "settings.connectors.github.disconnect": "中斷連線",
  "settings.connectors.github.cancel": "取消",
  "settings.connectors.github.openBrowser": "開啟瀏覽器",
  "settings.connectors.github.waiting": "等待授權…",
  "settings.connectors.github.code.instructions": "在以下位置輸入此代碼",
  "settings.connectors.github.connected.text": "已透過 OAuth 連線。Jarvis 可以存取你的 GitHub 帳戶。",
  "settings.connectors.github.error.expired": "授權代碼已過期，請重試。",
  "settings.connectors.github.error.generic": "無法連線到 GitHub。請檢查連線後重試。",
  "settings.connectors.github.error.denied": "授權已遭拒絕。你可以隨時重試。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 Jarvis 伺服器。",
  ...
  "settings.general.row.language.description": "變更 Jarvis 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 Jarvis 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 Jarvis 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 Jarvis 的主題。",
  ...
  "settings.updates.row.startup.description": "在 Jarvis 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 Jarvis。",
