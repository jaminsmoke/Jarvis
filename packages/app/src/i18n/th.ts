export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "ไม่ได้ติดตั้ง Jarvis ในดิสโทรนี้",
  "desktop.wsl.error.opencodeCannotRun": "ติดตั้ง Jarvis แล้ว แต่ไม่สามารถเรียกใช้ได้",
  ...
  "dialog.model.unpaid.freeModels.title": "โมเดลฟรีที่จัดหาให้โดย Jarvis",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen ให้คุณเข้าถึงชุดโมเดลที่เชื่อถือได้และปรับแต่งแล้วสำหรับเอเจนต์การเขียนโค้ด",
  ...
  "titlebar.toggleDebugTools": "สลับเครื่องมือดีบัก",
...
"settings.connectors.github.connect": "เชื่อมต่อ GitHub",
  ...
  "settings.connectors.google.summary": "เชื่อมต่อบัญชี Google ของคุณเพื่อให้ Jarvis อ่านและจัดการเอกสารใน Drive ของคุณได้",
  "settings.connectors.google.detail": "เชื่อมต่อบัญชี Google ของคุณเพื่อให้ Jarvis เข้าถึง Google Drive และ Docs ของคุณได้ คุณอนุญาตการเข้าถึงด้วยบัญชี Google ของคุณผ่าน OAuth - Jarvis ไม่เคยเห็นรหัสผ่านของคุณ",
  "settings.connectors.google.permission.drive": "อ่านไฟล์ Google Drive ของคุณ",
  "settings.connectors.google.permission.profile": "อ่านโปรไฟล์ของคุณ (ชื่อและอีเมล)",
  "settings.connectors.google.connect": "เชื่อมต่อ Google",
  "settings.connectors.google.disconnect": "ยกเลิกการเชื่อมต่อ",
  "settings.connectors.google.cancel": "ยกเลิก",
  "settings.connectors.google.openBrowser": "เปิดเบราว์เซอร์",
  "settings.connectors.google.waiting": "กำลังรอการอนุญาต…",
  "settings.connectors.google.code.instructions": "ป้อนรหัสนี้บน",
  "settings.connectors.google.connected.text": "เชื่อมต่อผ่าน OAuth แล้ว Jarvis สามารถเข้าถึงบัญชี Google ของคุณได้",
  "settings.connectors.google.error.expired": "รหัสอนุญาตหมดอายุแล้ว ลองอีกครั้ง",
  "settings.connectors.google.error.generic": "ไม่สามารถเชื่อมต่อกับ Google ได้ โปรดตรวจสอบการเชื่อมต่อของคุณแล้วลองอีกครั้ง",
  "settings.connectors.google.error.denied": "การอนุญาตถูกปฏิเสธ คุณสามารถลองอีกครั้งได้ทุกเมื่อ",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "เชื่อมต่อบัญชี Microsoft ของคุณเพื่อให้ Jarvis เข้าถึง OneDrive อีเมล และโปรไฟล์ของคุณได้",
  "settings.connectors.microsoft.detail": "เชื่อมต่อบัญชี Microsoft ของคุณเพื่อให้ Jarvis เข้าถึงไฟล์และโปรไฟล์ใน OneDrive ของคุณได้ คุณอนุญาตการเข้าถึงด้วยบัญชี Microsoft ของคุณผ่าน OAuth - Jarvis ไม่เคยเห็นรหัสผ่านของคุณ",
  "settings.connectors.microsoft.permission.files": "อ่านไฟล์ OneDrive ของคุณ",
  "settings.connectors.microsoft.permission.profile": "อ่านโปรไฟล์ของคุณ (ชื่อและอีเมล)",
  "settings.connectors.microsoft.connect": "เชื่อมต่อ Microsoft",
  "settings.connectors.microsoft.disconnect": "ยกเลิกการเชื่อมต่อ",
  "settings.connectors.microsoft.cancel": "ยกเลิก",
  "settings.connectors.microsoft.openBrowser": "เปิดเบราว์เซอร์",
  "settings.connectors.microsoft.waiting": "กำลังรอการอนุญาต…",
  "settings.connectors.microsoft.code.instructions": "ป้อนรหัสนี้บน",
  "settings.connectors.microsoft.connected.text": "เชื่อมต่อผ่าน OAuth แล้ว Jarvis สามารถเข้าถึงบัญชี Microsoft ของคุณได้",
  "settings.connectors.microsoft.error.expired": "รหัสอนุญาตหมดอายุแล้ว ลองอีกครั้ง",
  "settings.connectors.microsoft.error.generic": "ไม่สามารถเชื่อมต่อกับ Microsoft ได้ โปรดตรวจสอบการเชื่อมต่อของคุณแล้วลองอีกครั้ง",
  "settings.connectors.microsoft.error.denied": "การอนุญาตถูกปฏิเสธ คุณสามารถลองอีกครั้งได้ทุกเมื่อ",
  ...
  "dialog.usageExceeded.dontShowAgain": "ไม่แสดงอีกครั้ง",
