export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Jarvis",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "titlebar.toggleDebugTools": "Vis/skjul fejlfindingsværktøjer",
...
"settings.connectors.github.connect": "Forbind GitHub",
  ...
  "settings.connectors.google.summary": "Forbind din Google-konto, så Jarvis kan læse og administrere dine Drive-dokumenter.",
  "settings.connectors.google.detail": "Forbind din Google-konto, så Jarvis kan få adgang til dine Google Drive- og Docs-dokumenter. Du giver adgang med din egen Google-konto via OAuth - Jarvis ser aldrig din adgangskode.",
  "settings.connectors.google.permission.drive": "Læs dine Google Drive-filer",
  "settings.connectors.google.permission.profile": "Læs din profil (navn og e-mail)",
  "settings.connectors.google.connect": "Forbind Google",
  "settings.connectors.google.disconnect": "Afbryd",
  "settings.connectors.google.cancel": "Annuller",
  "settings.connectors.google.openBrowser": "Åbn browser",
  "settings.connectors.google.waiting": "Venter på godkendelse…",
  "settings.connectors.google.code.instructions": "Indtast denne kode på",
  "settings.connectors.google.connected.text": "Forbundet via OAuth. Jarvis kan få adgang til din Google-konto.",
  "settings.connectors.google.error.expired": "Godkendelseskoden er udløbet. Prøv igen.",
  "settings.connectors.google.error.generic": "Kunne ikke oprette forbindelse til Google. Tjek din forbindelse, og prøv igen.",
  "settings.connectors.google.error.denied": "Godkendelse afvist. Du kan prøve igen, når du vil.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Forbind din Microsoft-konto, så Jarvis kan få adgang til OneDrive, mail og din profil.",
  "settings.connectors.microsoft.detail": "Forbind din Microsoft-konto, så Jarvis kan få adgang til dine OneDrive-filer og din profil. Du giver adgang med din egen Microsoft-konto via OAuth - Jarvis ser aldrig din adgangskode.",
  "settings.connectors.microsoft.permission.files": "Læs dine OneDrive-filer",
  "settings.connectors.microsoft.permission.profile": "Læs din profil (navn og e-mail)",
  "settings.connectors.microsoft.connect": "Forbind Microsoft",
  "settings.connectors.microsoft.disconnect": "Afbryd",
  "settings.connectors.microsoft.cancel": "Annuller",
  "settings.connectors.microsoft.openBrowser": "Åbn browser",
  "settings.connectors.microsoft.waiting": "Venter på godkendelse…",
  "settings.connectors.microsoft.code.instructions": "Indtast denne kode på",
  "settings.connectors.microsoft.connected.text": "Forbundet via OAuth. Jarvis kan få adgang til din Microsoft-konto.",
  "settings.connectors.microsoft.error.expired": "Godkendelseskoden er udløbet. Prøv igen.",
  "settings.connectors.microsoft.error.generic": "Kunne ikke oprette forbindelse til Microsoft. Tjek din forbindelse, og prøv igen.",
  "settings.connectors.microsoft.error.denied": "Godkendelse afvist. Du kan prøve igen, når du vil.",
  ...
  "desktop.wsl.error.opencodeMissing": "Jarvis er ikke installeret i denne distribution",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis er installeret, men kunne ikke køre",
