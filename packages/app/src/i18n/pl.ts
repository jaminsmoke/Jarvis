export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "Program Jarvis nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.opencodeCannotRun": "Program Jarvis jest zainstalowany, ale nie można go uruchomić",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Jarvis",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
...
"settings.connectors.github.connect": "Połącz GitHub",
  ...
  "settings.connectors.google.summary": "Połącz swoje konto Google, aby Jarvis mógł czytać i zarządzać Twoimi dokumentami z Drive.",
  "settings.connectors.google.detail": "Połącz swoje konto Google, aby Jarvis mógł uzyskać dostęp do Twoich dokumentów Google Drive i Docs. Udzielasz dostępu własnym kontem Google przez OAuth - Jarvis nigdy nie widzi Twojego hasła.",
  "settings.connectors.google.permission.drive": "Czytanie Twoich plików z Google Drive",
  "settings.connectors.google.permission.profile": "Czytanie Twojego profilu (nazwa i e-mail)",
  "settings.connectors.google.connect": "Połącz Google",
  "settings.connectors.google.disconnect": "Rozłącz",
  "settings.connectors.google.cancel": "Anuluj",
  "settings.connectors.google.openBrowser": "Otwórz przeglądarkę",
  "settings.connectors.google.waiting": "Oczekiwanie na autoryzację…",
  "settings.connectors.google.code.instructions": "Wprowadź ten kod na",
  "settings.connectors.google.connected.text": "Połączono przez OAuth. Jarvis może uzyskać dostęp do Twojego konta Google.",
  "settings.connectors.google.error.expired": "Kod autoryzacji wygasł. Spróbuj ponownie.",
  "settings.connectors.google.error.generic": "Nie udało się połączyć z Google. Sprawdź połączenie i spróbuj ponownie.",
  "settings.connectors.google.error.denied": "Autoryzacja odrzucona. Możesz spróbować ponownie w dowolnym momencie.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Połącz swoje konto Microsoft, aby Jarvis mógł uzyskać dostęp do OneDrive, poczty i Twojego profilu.",
  "settings.connectors.microsoft.detail": "Połącz swoje konto Microsoft, aby Jarvis mógł uzyskać dostęp do Twoich plików z OneDrive i profilu. Udzielasz dostępu własnym kontem Microsoft przez OAuth - Jarvis nigdy nie widzi Twojego hasła.",
  "settings.connectors.microsoft.permission.files": "Czytanie Twoich plików z OneDrive",
  "settings.connectors.microsoft.permission.profile": "Czytanie Twojego profilu (nazwa i e-mail)",
  "settings.connectors.microsoft.connect": "Połącz Microsoft",
  "settings.connectors.microsoft.disconnect": "Rozłącz",
  "settings.connectors.microsoft.cancel": "Anuluj",
  "settings.connectors.microsoft.openBrowser": "Otwórz przeglądarkę",
  "settings.connectors.microsoft.waiting": "Oczekiwanie na autoryzację…",
  "settings.connectors.microsoft.code.instructions": "Wprowadź ten kod na",
  "settings.connectors.microsoft.connected.text": "Połączono przez OAuth. Jarvis może uzyskać dostęp do Twojego konta Microsoft.",
  "settings.connectors.microsoft.error.expired": "Kod autoryzacji wygasł. Spróbuj ponownie.",
  "settings.connectors.microsoft.error.generic": "Nie udało się połączyć z Microsoft. Sprawdź połączenie i spróbuj ponownie.",
  "settings.connectors.microsoft.error.denied": "Autoryzacja odrzucona. Możesz spróbować ponownie w dowolnym momencie.",
