export const dict = {
  ...
  "desktop.recovery.loadFailed": "Jarvis yüklənə bilmədi",
  "desktop.recovery.terminated": "Jarvis pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "Jarvis cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "Jarvis quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.opencodeMissing": "Bu distribütivdə Jarvis quraşdırılmayıb",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "Jarvis yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və Jarvis-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və Jarvis-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və Jarvis-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu Jarvis serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "Jarvis yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də Jarvis yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "Jarvis yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də Jarvis yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də Jarvis-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "Jarvis-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "Jarvis {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "Jarvis hazırdır.",
  "wsl.onboarding.installOpencodeIn": "Jarvis-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "Jarvis quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Jarvis WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "Jarvis bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra Jarvis-u yenidən açın.",
  ...
  "help.tabs.introduction": "Jarvis Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Jarvis-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı Jarvis komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: Jarvis hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "titlebar.toggleDebugTools": "Sazlama alətlərini aç/bağla",
  ...
  "sidebar.gettingStarted.line1": "Jarvis-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.tab.integrations": "İnteqrasiyalar",
  "settings.tab.connectors": "Konnektorlar",
  "settings.integrations.placeholder": "İnteqrasiyalar Jarvis runtimını genişləndirir. Tezliklə plaginlər, mövzular və sistem genişləndirmələri quraşdıra biləcəksiniz.",
  "settings.connectors.placeholder": "Konnektorlar Jarvis-i xarici xidmətlərə bağlayır. Tezliklə: Gmail, WhatsApp, Slack, Notion, Telegram və daha çoxu.",
  "settings.connectors.unavailable": "Konnektorlar yalnız masaüstü tətbiqində mövcuddur.",
  ...
  "settings.connectors.github.permission.repos": "Depolarınızı, issue və pull request-lərinizi oxuyun və idarə edin",
  "settings.connectors.github.permission.profile": "İctimai profilinizi oxuyun (istifadəçi adı və avatar)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "GitHub-a qoşul",
  "settings.connectors.github.disconnect": "Əlaqəni kəs",
  "settings.connectors.github.cancel": "Ləğv et",
  "settings.connectors.github.openBrowser": "Brauzeri aç",
  "settings.connectors.github.waiting": "İcazə gözlənilir…",
  "settings.connectors.github.code.instructions": "Bu kodu daxil edin",
  "settings.connectors.github.connected.text": "OAuth vasitəsilə qoşulub. Jarvis GitHub hesabınıza daxil ola bilər.",
  "settings.connectors.github.error.expired": "İcazə kodu müddəti bitib. Yenidən cəhd edin.",
  "settings.connectors.github.error.generic": "GitHub-a qoşulmaq mümkün olmadı. Bağlantınızı yoxlayın və yenidən cəhd edin.",
  "settings.connectors.github.error.denied": "İcazə rədd edildi. İstədiyiniz vaxt yenidən cəhd edə bilərsiniz.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Google hesabınızı qoşun ki, Jarvis Drive sənədlərinizi oxuya və idarə edə bilsin.",
  "settings.connectors.google.detail": "Google hesabınızı qoşun ki, Jarvis Google Drive və Docs-a daxil ola bilsin. Siz OAuth vasitəsilə Google hesabınızla girişi səlahiyyətləndirirsiniz - Jarvis şifrənizi heç vaxt görmür.",
  "settings.connectors.google.permission.drive": "Google Drive fayllarınızı oxuyun",
  "settings.connectors.google.permission.profile": "Profilinizi oxuyun (ad və e-poçt)",
  "settings.connectors.google.connect": "Google-a qoşul",
  "settings.connectors.google.disconnect": "Əlaqəni kəs",
  "settings.connectors.google.cancel": "Ləğv et",
  "settings.connectors.google.openBrowser": "Brauzeri aç",
  "settings.connectors.google.waiting": "İcazə gözlənilir…",
  "settings.connectors.google.code.instructions": "Bu kodu daxil edin",
  "settings.connectors.google.connected.text": "OAuth vasitəsilə qoşulub. Jarvis Google hesabınıza daxil ola bilər.",
  "settings.connectors.google.error.expired": "İcazə kodu müddəti bitib. Yenidən cəhd edin.",
  "settings.connectors.google.error.generic": "Google-a qoşulmaq mümkün olmadı. Bağlantınızı yoxlayın və yenidən cəhd edin.",
  "settings.connectors.google.error.denied": "İcazə rədd edildi. İstədiyiniz vaxt yenidən cəhd edə bilərsiniz.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Microsoft hesabınızı qoşun ki, Jarvis OneDrive, e-poçt və profilinizə daxil ola bilsin.",
  "settings.connectors.microsoft.detail": "Microsoft hesabınızı qoşun ki, Jarvis OneDrive fayllarınıza və profilinizə daxil ola bilsin. Siz OAuth vasitəsilə Microsoft hesabınızla girişi səlahiyyətləndirirsiniz - Jarvis şifrənizi heç vaxt görmür.",
  "settings.connectors.microsoft.permission.files": "OneDrive fayllarınızı oxuyun",
  "settings.connectors.microsoft.permission.profile": "Profilinizi oxuyun (ad və e-poçt)",
  "settings.connectors.microsoft.connect": "Microsoft-a qoşul",
  "settings.connectors.microsoft.disconnect": "Əlaqəni kəs",
  "settings.connectors.microsoft.cancel": "Ləğv et",
  "settings.connectors.microsoft.openBrowser": "Brauzeri aç",
  "settings.connectors.microsoft.waiting": "İcazə gözlənilir…",
  "settings.connectors.microsoft.code.instructions": "Bu kodu daxil edin",
  "settings.connectors.microsoft.connected.text": "OAuth vasitəsilə qoşulub. Jarvis Microsoft hesabınıza daxil ola bilər.",
  "settings.connectors.microsoft.error.expired": "İcazə kodu müddəti bitib. Yenidən cəhd edin.",
  "settings.connectors.microsoft.error.generic": "Microsoft-a qoşulmaq mümkün olmadı. Bağlantınızı yoxlayın və yenidən cəhd edin.",
  "settings.connectors.microsoft.error.denied": "İcazə rədd edildi. İstədiyiniz vaxt yenidən cəhd edə bilərsiniz.",
  "desktop.menu.wiki": "Viki",
  "command.session.export": "Sessiyanı ixrac et",
  "command.session.export.description": "Sessiyanın tam transkriptini JSON olaraq ixrac edin",
  "context.export.session": "Sessiyanı ixrac et",
  "toast.session.export.success.title": "Sessiya ixrac edildi",
  "toast.session.export.success.description": "Sessiya {{filename}} faylında saxlanıldı",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində Jarvis serverini işlət.",
  ...
  "settings.general.row.language.description": "Jarvis üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "Jarvis-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "Jarvis-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "Jarvis-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "Jarvis açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "Jarvis-un ən son versiyasından istifadə edirsiniz.",
