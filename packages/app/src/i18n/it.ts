export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da Jarvis",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "dialog.usageExceeded.dontShowAgain": "Non mostrare di nuovo",
  ...
  "titlebar.toggleDebugTools": "Mostra o nascondi gli strumenti di debug",
...
"settings.connectors.github.connect": "Connetti GitHub",
  ...
  "settings.connectors.google.summary": "Collega il tuo account Google per permettere a Jarvis di leggere e gestire i tuoi documenti di Drive.",
  "settings.connectors.google.detail": "Collega il tuo account Google così Jarvis può accedere ai tuoi documenti di Google Drive e Docs. Autorizzi l'accesso con il tuo account Google tramite OAuth - Jarvis non vede mai la tua password.",
  "settings.connectors.google.permission.drive": "Leggere i tuoi file di Google Drive",
  "settings.connectors.google.permission.profile": "Leggere il tuo profilo (nome ed email)",
  "settings.connectors.google.connect": "Connetti Google",
  "settings.connectors.google.disconnect": "Disconnetti",
  "settings.connectors.google.cancel": "Annulla",
  "settings.connectors.google.openBrowser": "Apri browser",
  "settings.connectors.google.waiting": "In attesa di autorizzazione…",
  "settings.connectors.google.code.instructions": "Inserisci questo codice su",
  "settings.connectors.google.connected.text": "Connesso via OAuth. Jarvis può accedere al tuo account Google.",
  "settings.connectors.google.error.expired": "Il codice di autorizzazione è scaduto. Riprova.",
  "settings.connectors.google.error.generic": "Impossibile connettersi a Google. Controlla la connessione e riprova.",
  "settings.connectors.google.error.denied": "Autorizzazione negata. Puoi riprovare quando vuoi.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Collega il tuo account Microsoft così Jarvis può accedere a OneDrive, alla posta e al tuo profilo.",
  "settings.connectors.microsoft.detail": "Collega il tuo account Microsoft così Jarvis può accedere ai tuoi file di OneDrive e al tuo profilo. Autorizzi l'accesso con il tuo account Microsoft tramite OAuth - Jarvis non vede mai la tua password.",
  "settings.connectors.microsoft.permission.files": "Leggere i tuoi file di OneDrive",
  "settings.connectors.microsoft.permission.profile": "Leggere il tuo profilo (nome ed email)",
  "settings.connectors.microsoft.connect": "Connetti Microsoft",
  "settings.connectors.microsoft.disconnect": "Disconnetti",
  "settings.connectors.microsoft.cancel": "Annulla",
  "settings.connectors.microsoft.openBrowser": "Apri browser",
  "settings.connectors.microsoft.waiting": "In attesa di autorizzazione…",
  "settings.connectors.microsoft.code.instructions": "Inserisci questo codice su",
  "settings.connectors.microsoft.connected.text": "Connesso via OAuth. Jarvis può accedere al tuo account Microsoft.",
  "settings.connectors.microsoft.error.expired": "Il codice di autorizzazione è scaduto. Riprova.",
  "settings.connectors.microsoft.error.generic": "Impossibile connettersi a Microsoft. Controlla la connessione e riprova.",
  "settings.connectors.microsoft.error.denied": "Autorizzazione negata. Puoi riprovare quando vuoi.",
  ...
  "desktop.wsl.error.opencodeMissing": "Jarvis non è installato in questa distribuzione",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis è installato, ma non è stato possibile eseguirlo",
