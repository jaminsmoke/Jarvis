...
export const dict = {
  ...
  "settings.connectors.google.summary": "Connect your Google account so Jarvis can read and manage your Drive documents.",
  "settings.connectors.google.detail": "Connect your Google account so Jarvis can access your Google Drive and Docs. You authorize access with your own Google account via OAuth - Jarvis never sees your password.",
  "settings.connectors.google.permission.drive": "Read your Google Drive files",
  "settings.connectors.google.permission.profile": "Read your profile (name and email)",
  "settings.connectors.google.connect": "Connect Google",
  "settings.connectors.google.disconnect": "Disconnect",
  "settings.connectors.google.cancel": "Cancel",
  "settings.connectors.google.openBrowser": "Open browser",
  "settings.connectors.google.waiting": "Waiting for authorization...",
  "settings.connectors.google.code.instructions": "Enter this code at",
  "settings.connectors.google.connected.text": "Connected via OAuth. Jarvis can access your Google account.",
  "settings.connectors.google.error.expired": "The authorization code has expired. Try again.",
  "settings.connectors.google.error.generic": "Could not connect to Google. Check your connection and try again.",
  "settings.connectors.google.error.denied": "Authorization denied. You can try again whenever you want.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Connect your Microsoft account so Jarvis can access OneDrive, mail and your profile.",
  "settings.connectors.microsoft.detail": "Connect your Microsoft account so Jarvis can access your OneDrive files and profile. You authorize access with your own Microsoft account via OAuth - Jarvis never sees your password.",
  "settings.connectors.microsoft.permission.files": "Read your OneDrive files",
  "settings.connectors.microsoft.permission.profile": "Read your profile (name and email)",
  "settings.connectors.microsoft.connect": "Connect Microsoft",
  "settings.connectors.microsoft.disconnect": "Disconnect",
  "settings.connectors.microsoft.cancel": "Cancel",
  "settings.connectors.microsoft.openBrowser": "Open browser",
  "settings.connectors.microsoft.waiting": "Waiting for authorization...",
  "settings.connectors.microsoft.code.instructions": "Enter this code at",
  "settings.connectors.microsoft.connected.text": "Connected via OAuth. Jarvis can access your Microsoft account.",
  "settings.connectors.microsoft.error.expired": "The authorization code has expired. Try again.",
  "settings.connectors.microsoft.error.generic": "Could not connect to Microsoft. Check your connection and try again.",
  "settings.connectors.microsoft.error.denied": "Authorization denied. You can try again whenever you want.",
