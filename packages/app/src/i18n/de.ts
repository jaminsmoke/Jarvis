...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Jarvis",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Jarvis zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in Jarvis zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in Jarvis zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den Jarvis-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "Jarvis wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "Jarvis in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "Jarvis wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "Jarvis in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie Jarvis in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Jarvis aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "Jarvis ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "Jarvis ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie Jarvis in {{distro}}.",
  "wsl.onboarding.installOpencode": "Jarvis installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor Jarvis einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "Jarvis konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann Jarvis erneut.",
  ...
  "toast.update.description": "Eine neue Version von Jarvis ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Jarvis-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Jarvis unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "Jarvis mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "titlebar.toggleDebugTools": "Debug-Werkzeuge umschalten",
  ...
  "sidebar.gettingStarted.line1": "Jarvis enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.tab.connectors": "Konnektoren",
  "settings.integrations.placeholder": "Integrationen erweitern die Jarvis-Laufzeit. Bald kannst du Plugins, Themes und Systemerweiterungen installieren.",
  "settings.connectors.placeholder": "Konnektoren verbinden Jarvis mit externen Diensten. Bald: Gmail, WhatsApp, Slack, Notion, Telegram und mehr.",
  "settings.connectors.unavailable": "Konnektoren sind nur in der Desktop-App verfügbar.",
  "settings.connectors.badge.connected": "Verbunden",
  "settings.connectors.badge.notConnected": "Nicht verbunden",
  "settings.connectors.badge.disabled": "Deaktiviert",
  "settings.connectors.badge.comingSoon": "Coming soon",
  "settings.connectors.badge.tools": "tools",
  "settings.connectors.github.name": "GitHub",
  "settings.connectors.github.summary": "Verbinde dein GitHub-Konto, damit Jarvis deine Repositorys lesen und verwalten kann.",
  "settings.connectors.github.detail": "Verbinde dein GitHub-Konto, damit Jarvis direkt aus dem Chat mit deinen Repositorys, Issues und Pull Requests arbeiten kann. Du autorisierst den Zugriff mit deinem eigenen GitHub-Konto über OAuth — Jarvis sieht niemals dein Passwort.",
  "settings.connectors.github.permission.repos": "Deine Repositorys, Issues und Pull Requests lesen und verwalten",
  "settings.connectors.github.permission.profile": "Dein öffentliches Profil lesen (Benutzername und Avatar)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "GitHub verbinden",
  "settings.connectors.github.disconnect": "Trennen",
  "settings.connectors.github.cancel": "Abbrechen",
  "settings.connectors.github.openBrowser": "Browser öffnen",
  "settings.connectors.github.waiting": "Warte auf Autorisierung…",
  "settings.connectors.github.code.instructions": "Gib diesen Code ein bei",
  "settings.connectors.github.connected.text": "Über OAuth verbunden. Jarvis kann auf dein GitHub-Konto zugreifen.",
  "settings.connectors.github.error.expired": "Der Autorisierungscode ist abgelaufen. Bitte versuche es erneut.",
  "settings.connectors.github.error.generic": "Verbindung zu GitHub fehlgeschlagen. Überprüfe deine Verbindung und versuche es erneut.",
  "settings.connectors.github.error.denied": "Autorisierung abgelehnt. Du kannst es jederzeit erneut versuchen.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Verbinde dein Google-Konto, damit Jarvis deine Drive-Dokumente lesen und verwalten kann.",
  "settings.connectors.google.detail": "Verbinde dein Google-Konto, damit Jarvis auf deine Google Drive- und Docs-Dokumente zugreifen kann. Du autorisierst den Zugriff mit deinem eigenen Google-Konto über OAuth - Jarvis sieht niemals dein Passwort.",
  "settings.connectors.google.permission.drive": "Deine Google Drive-Dateien lesen",
  "settings.connectors.google.permission.profile": "Dein Profil lesen (Name und E-Mail)",
  "settings.connectors.google.connect": "Google verbinden",
  "settings.connectors.google.disconnect": "Trennen",
  "settings.connectors.google.cancel": "Abbrechen",
  "settings.connectors.google.openBrowser": "Browser öffnen",
  "settings.connectors.google.waiting": "Warte auf Autorisierung…",
  "settings.connectors.google.code.instructions": "Gib diesen Code ein bei",
  "settings.connectors.google.connected.text": "Über OAuth verbunden. Jarvis kann auf dein Google-Konto zugreifen.",
  "settings.connectors.google.error.expired": "Der Autorisierungscode ist abgelaufen. Bitte versuche es erneut.",
  "settings.connectors.google.error.generic": "Verbindung zu Google fehlgeschlagen. Überprüfe deine Verbindung und versuche es erneut.",
  "settings.connectors.google.error.denied": "Autorisierung abgelehnt. Du kannst es jederzeit erneut versuchen.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Verbinde dein Microsoft-Konto, damit Jarvis auf OneDrive, E-Mail und dein Profil zugreifen kann.",
  "settings.connectors.microsoft.detail": "Verbinde dein Microsoft-Konto, damit Jarvis auf deine OneDrive-Dateien und dein Profil zugreifen kann. Du autorisierst den Zugriff mit deinem eigenen Microsoft-Konto über OAuth - Jarvis sieht niemals dein Passwort.",
  "settings.connectors.microsoft.permission.files": "Deine OneDrive-Dateien lesen",
  "settings.connectors.microsoft.permission.profile": "Dein Profil lesen (Name und E-Mail)",
  "settings.connectors.microsoft.connect": "Microsoft verbinden",
  "settings.connectors.microsoft.disconnect": "Trennen",
  "settings.connectors.microsoft.cancel": "Abbrechen",
  "settings.connectors.microsoft.openBrowser": "Browser öffnen",
  "settings.connectors.microsoft.waiting": "Warte auf Autorisierung…",
  "settings.connectors.microsoft.code.instructions": "Gib diesen Code ein bei",
  "settings.connectors.microsoft.connected.text": "Über OAuth verbunden. Jarvis kann auf dein Microsoft-Konto zugreifen.",
  "settings.connectors.microsoft.error.expired": "Der Autorisierungscode ist abgelaufen. Bitte versuche es erneut.",
  "settings.connectors.microsoft.error.generic": "Verbindung zu Microsoft fehlgeschlagen. Überprüfe deine Verbindung und versuche es erneut.",
  "settings.connectors.microsoft.error.denied": "Autorisierung abgelehnt. Du kannst es jederzeit erneut versuchen.",
  ...
  "toast.session.export.success.description": "Sitzung gespeichert unter {{filename}}",
  ...
  "settings.desktop.wsl.description": "Jarvis-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Jarvis ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie Jarvis auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob Jarvis dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Jarvis anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Jarvis automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "Jarvis ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von Jarvis wird verwendet.",
  ...
  "desktop.menu.ariaLabel": "Jarvis-Menü",
  ...
  "desktop.recovery.loadFailed": "Jarvis konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das Jarvis-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "Jarvis reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "Jarvis-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.opencodeMissing": "Jarvis ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das Jarvis-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "Jarvis Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
