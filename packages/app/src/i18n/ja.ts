export const dict = {
  ...
  "desktop.recovery.loadFailed": "Jarvisを読み込めませんでした",
  "desktop.recovery.terminated": "Jarvisのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "Jarvisが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "Jarvisのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはJarvisがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "Jarvisのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "Jarvisが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、Jarvisで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してJarvisで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、Jarvisで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するJarvisサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "Jarvisを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のJarvisを確認中...",
  "wsl.onboarding.updatingOpencode": "Jarvisを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のJarvisを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のJarvisを更新してください。",
  "wsl.onboarding.updateOpencode": "Jarvisを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のJarvisの準備ができました。",
  "wsl.onboarding.opencodeReady": "Jarvisの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にJarvisをインストールしてください。",
  "wsl.onboarding.installOpencode": "Jarvisをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvisがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "JarvisでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、Jarvisをもう一度開いてください。",
  ...
  "help.tabs.introduction": "Jarvis Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Jarvisの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをJarvisチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: JarvisはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "Jarvisには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.tab.connectors": "コネクタ",
  "settings.integrations.placeholder": "統合はJarvisランタイムを拡張します。まもなくプラグイン、テーマ、システム拡張機能をインストールできるようになります。",
  "settings.connectors.placeholder": "コネクタはJarvisを外部サービスと接続します。近日公開: Gmail、WhatsApp、Slack、Notion、Telegramなど。",
  "settings.connectors.unavailable": "コネクタはデスクトップアプリでのみ利用できます。",
  ...
  "settings.connectors.github.permission.repos": "リポジトリ、Issue、プルリクエストの読み取りと管理",
  "settings.connectors.github.permission.profile": "公開プロフィールの読み取り（ユーザー名とアバター）",
  "settings.connectors.github.connect": "GitHubに接続",
  "settings.connectors.github.disconnect": "切断",
  "settings.connectors.github.cancel": "キャンセル",
  "settings.connectors.github.openBrowser": "ブラウザを開く",
  "settings.connectors.github.waiting": "認可待ち…",
  "settings.connectors.github.code.instructions": "このコードを入力してください:",
  "settings.connectors.github.connected.text": "OAuthで接続済み。JarvisはあなたのGitHubアカウントにアクセスできます。",
  "settings.connectors.github.error.expired": "認可コードの有効期限が切れました。もう一度お試しください。",
  "settings.connectors.github.error.generic": "GitHubに接続できませんでした。接続を確認して再試行してください。",
  "settings.connectors.github.error.denied": "認可が拒否されました。いつでも再試行できます。",
  ...
  "command.session.export.description": "セッションの完全な書き起こしをJSONとしてエクスポート",
  "context.export.session": "セッションをエクスポート",
  "toast.session.export.success.title": "セッションをエクスポートしました",
  "toast.session.export.success.description": "{{filename}}にセッションを保存しました",
  "toast.session.export.failed.title": "セッションのエクスポートに失敗",
  "toast.session.export.failed.description": "セッションのエクスポート中にエラーが発生しました",
  "common.export": "エクスポート",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL連携",
  "settings.desktop.wsl.description": "WindowsのWSL環境でJarvisサーバーを実行します。",
  ...
  "settings.general.row.language.description": "Jarvisの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのJarvisの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "Jarvisがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "Jarvisのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "Jarvis の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "Jarvis は最新バージョンです。",
