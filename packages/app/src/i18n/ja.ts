export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはJarvisがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "Jarvisはインストールされていますが、実行できませんでした",
...
"settings.connectors.github.connect": "GitHubに接続",
  ...
  "settings.connectors.google.summary": "Googleアカウントを接続すると、JarvisがDriveドキュメントを読み取り・管理できるようになります。",
  "settings.connectors.google.detail": "Googleアカウントを接続すると、JarvisがGoogle DriveとDocsにアクセスできるようになります。アクセスはご自身のGoogleアカウントでOAuthにより許可します - Jarvisがパスワードを見ることはありません。",
  "settings.connectors.google.permission.drive": "Google Driveのファイルの読み取り",
  "settings.connectors.google.permission.profile": "プロフィールの読み取り（名前とメールアドレス）",
  "settings.connectors.google.connect": "Googleに接続",
  "settings.connectors.google.disconnect": "切断",
  "settings.connectors.google.cancel": "キャンセル",
  "settings.connectors.google.openBrowser": "ブラウザを開く",
  "settings.connectors.google.waiting": "認可待ち…",
  "settings.connectors.google.code.instructions": "このコードを入力してください:",
  "settings.connectors.google.connected.text": "OAuthで接続済み。JarvisはあなたのGoogleアカウントにアクセスできます。",
  "settings.connectors.google.error.expired": "認可コードの有効期限が切れました。もう一度お試しください。",
  "settings.connectors.google.error.generic": "Googleに接続できませんでした。接続を確認して再試行してください。",
  "settings.connectors.google.error.denied": "認可が拒否されました。いつでも再試行できます。",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Microsoftアカウントを接続すると、JarvisがOneDrive、メール、プロフィールにアクセスできるようになります。",
  "settings.connectors.microsoft.detail": "Microsoftアカウントを接続すると、JarvisがOneDriveのファイルとプロフィールにアクセスできるようになります。アクセスはご自身のMicrosoftアカウントでOAuthにより許可します - Jarvisがパスワードを見ることはありません。",
  "settings.connectors.microsoft.permission.files": "OneDriveのファイルの読み取り",
  "settings.connectors.microsoft.permission.profile": "プロフィールの読み取り（名前とメールアドレス）",
  "settings.connectors.microsoft.connect": "Microsoftに接続",
  "settings.connectors.microsoft.disconnect": "切断",
  "settings.connectors.microsoft.cancel": "キャンセル",
  "settings.connectors.microsoft.openBrowser": "ブラウザを開く",
  "settings.connectors.microsoft.waiting": "認可待ち…",
  "settings.connectors.microsoft.code.instructions": "このコードを入力してください:",
  "settings.connectors.microsoft.connected.text": "OAuthで接続済み。JarvisはあなたのMicrosoftアカウントにアクセスできます。",
  "settings.connectors.microsoft.error.expired": "認可コードの有効期限が切れました。もう一度お試しください。",
  "settings.connectors.microsoft.error.generic": "Microsoftに接続できませんでした。接続を確認して再試行してください。",
  "settings.connectors.microsoft.error.denied": "認可が拒否されました。いつでも再試行できます。",
  ...
  "dialog.usageExceeded.dontShowAgain": "再び表示しない",
  ...
  "titlebar.toggleDebugTools": "デバッグツールの表示を切り替える",
}
