export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do Jarvis",
  ...
  "desktop.menu.ariaLabel": "Menu do Jarvis",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o Jarvis",
  "desktop.recovery.terminated": "A janela do Jarvis foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O Jarvis não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do Jarvis",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O Jarvis não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O Jarvis está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O Jarvis não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do Jarvis foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Jarvis.",
  ...
  "dialog.server.description": "Trocar para qual servidor Jarvis este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o Jarvis em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o Jarvis em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o Jarvis em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o Jarvis",
  "wsl.onboarding.opencodeReadyIn": "O Jarvis está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O Jarvis está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o Jarvis em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o Jarvis possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O Jarvis não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o Jarvis novamente.",
  ...
  "help.tabs.introduction": "Agora, o Jarvis Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do Jarvis ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Jarvis",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Jarvis ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.integrations.placeholder": "As integrações estendem o runtime do Jarvis. Em breve você poderá instalar plugins, temas e extensões do sistema.",
  "settings.connectors.placeholder": "Os conectores ligam o Jarvis a serviços externos. Em breve: Gmail, WhatsApp, Slack, Notion, Telegram e mais.",
  "settings.connectors.unavailable": "Os conectores estão disponíveis apenas no aplicativo desktop.",
  "settings.connectors.badge.connected": "Conectado",
  "settings.connectors.badge.notConnected": "Não conectado",
  "settings.connectors.badge.disabled": "Desativado",
  ...
  "settings.connectors.github.summary": "Conecte sua conta do GitHub para o Jarvis ler e gerenciar seus repositórios.",
  "settings.connectors.github.detail": "Conecte sua conta do GitHub para o Jarvis trabalhar com seus repositórios, issues e pull requests diretamente do chat. Você autoriza o acesso com sua própria conta do GitHub via OAuth — o Jarvis nunca vê sua senha.",
  "settings.connectors.github.permission.repos": "Ler e gerenciar seus repositórios, issues e pull requests",
  "settings.connectors.github.permission.profile": "Ler seu perfil público (nome de usuário e avatar)",
...
"settings.connectors.github.connect": "Conectar GitHub",
  ...
  "settings.connectors.github.waiting": "Aguardando autorização…",
  "settings.connectors.github.code.instructions": "Digite este código em",
  "settings.connectors.github.connected.text": "Conectado via OAuth. O Jarvis pode acessar sua conta do GitHub.",
  "settings.connectors.github.error.expired": "O código de autorização expirou. Tente novamente.",
  "settings.connectors.github.error.generic": "Não foi possível conectar ao GitHub. Verifique sua conexão e tente novamente.",
  "settings.connectors.github.error.denied": "Autorização negada. Você pode tentar novamente quando quiser.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Conecte sua conta do Google para o Jarvis ler e gerenciar seus documentos do Drive.",
  "settings.connectors.google.detail": "Conecte sua conta do Google para o Jarvis acessar seus documentos do Google Drive e Docs. Você autoriza o acesso com sua própria conta do Google via OAuth - o Jarvis nunca vê sua senha.",
  "settings.connectors.google.permission.drive": "Ler seus arquivos do Google Drive",
  "settings.connectors.google.permission.profile": "Ler seu perfil (nome e email)",
  "settings.connectors.google.connect": "Conectar Google",
  "settings.connectors.google.disconnect": "Desconectar",
  "settings.connectors.google.cancel": "Cancelar",
  "settings.connectors.google.openBrowser": "Abrir navegador",
  "settings.connectors.google.waiting": "Aguardando autorização…",
  "settings.connectors.google.code.instructions": "Digite este código em",
  "settings.connectors.google.connected.text": "Conectado via OAuth. O Jarvis pode acessar sua conta do Google.",
  "settings.connectors.google.error.expired": "O código de autorização expirou. Tente novamente.",
  "settings.connectors.google.error.generic": "Não foi possível conectar ao Google. Verifique sua conexão e tente novamente.",
  "settings.connectors.google.error.denied": "Autorização negada. Você pode tentar novamente quando quiser.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Conecte sua conta da Microsoft para o Jarvis acessar o OneDrive, os e-mails e seu perfil.",
  "settings.connectors.microsoft.detail": "Conecte sua conta da Microsoft para o Jarvis acessar seus arquivos do OneDrive e seu perfil. Você autoriza o acesso com sua própria conta da Microsoft via OAuth - o Jarvis nunca vê sua senha.",
  "settings.connectors.microsoft.permission.files": "Ler seus arquivos do OneDrive",
  "settings.connectors.microsoft.permission.profile": "Ler seu perfil (nome e email)",
  "settings.connectors.microsoft.connect": "Conectar Microsoft",
  "settings.connectors.microsoft.disconnect": "Desconectar",
  "settings.connectors.microsoft.cancel": "Cancelar",
  "settings.connectors.microsoft.openBrowser": "Abrir navegador",
  "settings.connectors.microsoft.waiting": "Aguardando autorização…",
  "settings.connectors.microsoft.code.instructions": "Digite este código em",
  "settings.connectors.microsoft.connected.text": "Conectado via OAuth. O Jarvis pode acessar sua conta da Microsoft.",
  "settings.connectors.microsoft.error.expired": "O código de autorização expirou. Tente novamente.",
  "settings.connectors.microsoft.error.generic": "Não foi possível conectar à Microsoft. Verifique sua conexão e tente novamente.",
  "settings.connectors.microsoft.error.denied": "Autorização negada. Você pode tentar novamente quando quiser.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Jarvis dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Jarvis",
  ...
  "settings.general.row.appearance.description": "Personalize como o Jarvis aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o Jarvis segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Jarvis é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Jarvis iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Jarvis.",
