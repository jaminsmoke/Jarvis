...
"settings.connectors.github.connect": "GitHub 연결",
  ...
  "settings.connectors.google.summary": "Google 계정을 연결하면 Jarvis가 Drive 문서를 읽고 관리할 수 있습니다.",
  "settings.connectors.google.detail": "Google 계정을 연결하면 Jarvis가 Google Drive와 Docs에 접근할 수 있습니다. OAuth를 통해 본인 Google 계정으로 접근을 승인합니다 - Jarvis는 비밀번호를 절대 볼 수 없습니다.",
  "settings.connectors.google.permission.drive": "Google Drive 파일 읽기",
  "settings.connectors.google.permission.profile": "프로필 읽기(이름 및 이메일)",
  "settings.connectors.google.connect": "Google 연결",
  "settings.connectors.google.disconnect": "연결 해제",
  "settings.connectors.google.cancel": "취소",
  "settings.connectors.google.openBrowser": "브라우저 열기",
  "settings.connectors.google.waiting": "인증 대기 중…",
  "settings.connectors.google.code.instructions": "이 코드를 입력하세요:",
  "settings.connectors.google.connected.text": "OAuth로 연결됨. Jarvis가 Google 계정에 접근할 수 있습니다.",
  "settings.connectors.google.error.expired": "인증 코드가 만료되었습니다. 다시 시도해 주세요.",
  "settings.connectors.google.error.generic": "Google에 연결할 수 없습니다. 연결을 확인하고 다시 시도하세요.",
  "settings.connectors.google.error.denied": "인증이 거부되었습니다. 원할 때 다시 시도할 수 있습니다.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Microsoft 계정을 연결하면 Jarvis가 OneDrive, 메일 및 프로필에 접근할 수 있습니다.",
  "settings.connectors.microsoft.detail": "Microsoft 계정을 연결하면 Jarvis가 OneDrive 파일과 프로필에 접근할 수 있습니다. OAuth를 통해 본인 Microsoft 계정으로 접근을 승인합니다 - Jarvis는 비밀번호를 절대 볼 수 없습니다.",
  "settings.connectors.microsoft.permission.files": "OneDrive 파일 읽기",
  "settings.connectors.microsoft.permission.profile": "프로필 읽기(이름 및 이메일)",
  "settings.connectors.microsoft.connect": "Microsoft 연결",
  "settings.connectors.microsoft.disconnect": "연결 해제",
  "settings.connectors.microsoft.cancel": "취소",
  "settings.connectors.microsoft.openBrowser": "브라우저 열기",
  "settings.connectors.microsoft.waiting": "인증 대기 중…",
  "settings.connectors.microsoft.code.instructions": "이 코드를 입력하세요:",
  "settings.connectors.microsoft.connected.text": "OAuth로 연결됨. Jarvis가 Microsoft 계정에 접근할 수 있습니다.",
  "settings.connectors.microsoft.error.expired": "인증 코드가 만료되었습니다. 다시 시도해 주세요.",
  "settings.connectors.microsoft.error.generic": "Microsoft에 연결할 수 없습니다. 연결을 확인하고 다시 시도하세요.",
  "settings.connectors.microsoft.error.denied": "인증이 거부되었습니다. 원할 때 다시 시도할 수 있습니다.",
  ...
  "titlebar.toggleDebugTools": "디버그 도구 표시/숨기기",
  ...
  "desktop.wsl.error.opencodeMissing": "이 배포판에 Jarvis가 설치되어 있지 않습니다",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis가 설치되어 있지만 실행할 수 없습니다",
