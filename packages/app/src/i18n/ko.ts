export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Jarvis에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Jarvis에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Jarvis에서 {{provider}} 모델을 사용하세요.",
  ...
  "dialog.server.description": "이 앱이 연결할 Jarvis 서버를 전환합니다.",
  ...
  "toast.update.description": "Jarvis의 새 버전({{version}})을 설치할 수 있습니다.",
  ...
  "error.page.report.prefix": "이 오류를 Jarvis 팀에 제보해 주세요: ",
  ...
  "error.chain.mcpFailed": 'MCP 서버 "{{name}}" 실패. 참고: Jarvis는 아직 MCP 인증을 지원하지 않습니다.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis에는 무료 모델이 포함되어 있어 즉시 시작할 수 있습니다.",
  ...
  "settings.tab.integrations": "통합",
  "settings.tab.connectors": "커넥터",
  "settings.integrations.placeholder": "통합 기능은 Jarvis 런타임을 확장합니다. 곧 플러그인, 테마, 시스템 확장을 설치할 수 있게 됩니다.",
  "settings.connectors.placeholder": "커넥터는 Jarvis를 외부 서비스와 연결합니다. 곧 제공: Gmail, WhatsApp, Slack, Notion, Telegram 등.",
  "settings.connectors.unavailable": "커넥터는 데스크톱 앱에서만 사용할 수 있습니다.",
  ...
  "settings.connectors.github.permission.repos": "저장소, 이슈, 풀 리퀘스트 읽기 및 관리",
  "settings.connectors.github.permission.profile": "공개 프로필 읽기(사용자 이름 및 아바타)",
  "settings.connectors.github.connect": "GitHub 연결",
  "settings.connectors.github.disconnect": "연결 해제",
  "settings.connectors.github.cancel": "취소",
  "settings.connectors.github.openBrowser": "브라우저 열기",
  "settings.connectors.github.waiting": "인증 대기 중…",
  "settings.connectors.github.code.instructions": "이 코드를 입력하세요:",
  "settings.connectors.github.connected.text": "OAuth로 연결됨. Jarvis가 GitHub 계정에 접근할 수 있습니다.",
  "settings.connectors.github.error.expired": "인증 코드가 만료되었습니다. 다시 시도해 주세요.",
  "settings.connectors.github.error.generic": "GitHub에 연결할 수 없습니다. 연결을 확인하고 다시 시도하세요.",
  "settings.connectors.github.error.denied": "인증이 거부되었습니다. 원할 때 다시 시도할 수 있습니다.",
  ...
  "desktop.menu.wiki": "위키",
  "command.session.export": "세션 내보내기",
  "command.session.export.description": "세션 전체 기록을 JSON으로 내보내기",
  "context.export.session": "세션 내보내기",
  "toast.session.export.success.title": "세션 내보냄",
  "toast.session.export.success.description": "{{filename}}에 세션 저장됨",
  ...
  "settings.desktop.wsl.description": "Windows의 WSL 내부에서 Jarvis 서버를 실행합니다.",
  ...
  "settings.general.row.language.description": "Jarvis 표시 언어 변경",
  "settings.general.row.appearance.title": "모양",
  "settings.general.row.appearance.description": "기기에서 Jarvis가 보이는 방식 사용자 지정",
  "settings.general.row.colorScheme.title": "색상 테마",
  "settings.general.row.colorScheme.description": "Jarvis가 시스템, 라이트 또는 다크 테마를 따를지 선택하세요",
  "settings.general.row.theme.title": "테마",
  "settings.general.row.theme.description": "Jarvis 테마 사용자 지정",
  ...
  "settings.updates.row.startup.description": "Jarvis를 실행할 때 업데이트를 자동으로 확인합니다",
  ...
  "settings.updates.toast.latest.description": "현재 최신 버전의 Jarvis를 사용 중입니다.",
  ...
  "wsl.onboarding.checkingOpencode": "Jarvis 확인 중...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}에서 Jarvis 확인 중...",
  "wsl.onboarding.updatingOpencode": "Jarvis 업데이트 중...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}에서 Jarvis 업데이트 중...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}에서 Jarvis를 업데이트하세요.",
  "wsl.onboarding.updateOpencode": "Jarvis 업데이트",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}에서 Jarvis를 사용할 준비가 되었습니다.",
  "wsl.onboarding.opencodeReady": "Jarvis가 준비되었습니다.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}에 Jarvis를 설치하세요.",
  "wsl.onboarding.installOpencode": "Jarvis 설치",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis가 설치되지 않음",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Jarvis에서 WSL 서버를 추가하려면 WSL (Windows Subsystem for Linux)이 필요합니다",
  "wsl.onboarding.wslUnavailable.title": "WSL을 사용할 수 없음",
  "wsl.onboarding.wslUnavailable.description": "Jarvis에서 이 컴퓨터의 WSL을 확인할 수 없습니다.",
  "wsl.onboarding.installWsl": "WSL 설치",
  "wsl.onboarding.windowsRestartRequired": "WSL 설치를 완료하려면 Windows를 다시 시작한 다음 Jarvis를 다시 여세요.",
  ...
  "help.tabs.introduction": "이제 Jarvis Desktop은 탭을 중심으로 구성됩니다.",
  "help.tabs.sessions":
  ...
  "desktop.recovery.loadFailed": "Jarvis를 불러오지 못했습니다",
  "desktop.recovery.terminated": "Jarvis 윈도우가 예기치 않게 종료되었습니다",
  "desktop.recovery.unresponsive": "Jarvis가 응답하지 않습니다",
  ...
  "desktop.wsl.error.installOpencode": "Jarvis 설치 실패",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}에 Jarvis가 설치되어 있지 않습니다",
  "desktop.wsl.error.updateVersion":
    "Jarvis 업데이트가 완료되었지만 {{distro}}에서 여전히 {{installed}} 버전으로 표시됩니다. 예상 버전: {{expected}}",
