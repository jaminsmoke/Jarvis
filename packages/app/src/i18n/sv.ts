export const dict = {
  ...
  "desktop.recovery.loadFailed": "Jarvis kunde inte läsas in",
  "desktop.recovery.terminated": "Jarvis-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "Jarvis svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av Jarvis misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.opencodeMissing": "Jarvis är inte installerat i den här distributionen",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis är installerat men kunde inte köras",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Jarvis-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i Jarvis.",
  ...
  "dialog.server.description": "Växla vilken Jarvis-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar Jarvis i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar Jarvis i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera Jarvis i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera Jarvis i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan Jarvis kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "Jarvis kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan Jarvis igen.",
  ...
  "help.tabs.introduction": "Jarvis Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av Jarvis ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till Jarvis-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, Jarvis stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "Jarvis innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.tab.connectors": "Kontakter",
  "settings.integrations.placeholder": "Integrationer utökar Jarvis körtid. Snart kan du installera plugins, teman och systemtillägg.",
  "settings.connectors.placeholder": "Kontakter kopplar Jarvis till externa tjänster. Kommer snart: Gmail, WhatsApp, Slack, Notion, Telegram med mera.",
  "settings.connectors.unavailable": "Kontakter är endast tillgängliga i skrivbordsappen.",
  ...
  "settings.connectors.github.permission.repos": "Läsa och hantera dina databaser, ärenden och pull requests",
  "settings.connectors.github.permission.profile": "Läsa din offentliga profil (användarnamn och avatar)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "Anslut GitHub",
  "settings.connectors.github.disconnect": "Koppla från",
  "settings.connectors.github.cancel": "Avbryt",
  "settings.connectors.github.openBrowser": "Öppna webbläsare",
  "settings.connectors.github.waiting": "Väntar på auktorisering…",
  "settings.connectors.github.code.instructions": "Ange den här koden på",
  "settings.connectors.github.connected.text": "Ansluten via OAuth. Jarvis kan komma åt ditt GitHub-konto.",
  "settings.connectors.github.error.expired": "Auktoriseringskoden har upphört att gälla. Försök igen.",
  "settings.connectors.github.error.generic": "Kunde inte ansluta till GitHub. Kontrollera anslutningen och försök igen.",
  "settings.connectors.github.error.denied": "Auktorisering nekad. Du kan försöka igen när du vill.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "Anslut ditt Google-konto så att Jarvis kan läsa och hantera dina Drive-dokument.",
  "settings.connectors.google.detail": "Anslut ditt Google-konto så att Jarvis kan komma åt Google Drive och Docs. Du beviljar åtkomst med ditt eget Google-konto via OAuth - Jarvis ser aldrig ditt lösenord.",
  "settings.connectors.google.permission.drive": "Läsa dina Google Drive-filer",
  "settings.connectors.google.permission.profile": "Läsa din profil (namn och e-post)",
  "settings.connectors.google.connect": "Anslut Google",
  "settings.connectors.google.disconnect": "Koppla från",
  "settings.connectors.google.cancel": "Avbryt",
  "settings.connectors.google.openBrowser": "Öppna webbläsare",
  "settings.connectors.google.waiting": "Väntar på auktorisering…",
  "settings.connectors.google.code.instructions": "Ange den här koden på",
  "settings.connectors.google.connected.text": "Ansluten via OAuth. Jarvis kan komma åt ditt Google-konto.",
  "settings.connectors.google.error.expired": "Auktoriseringskoden har upphört att gälla. Försök igen.",
  "settings.connectors.google.error.generic": "Kunde inte ansluta till Google. Kontrollera anslutningen och försök igen.",
  "settings.connectors.google.error.denied": "Auktorisering nekad. Du kan försöka igen när du vill.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Anslut ditt Microsoft-konto så att Jarvis kan komma åt OneDrive, e-post och din profil.",
  "settings.connectors.microsoft.detail": "Anslut ditt Microsoft-konto så att Jarvis kan komma åt dina OneDrive-filer och din profil. Du beviljar åtkomst med ditt eget Microsoft-konto via OAuth - Jarvis ser aldrig ditt lösenord.",
  "settings.connectors.microsoft.permission.files": "Läsa dina OneDrive-filer",
  "settings.connectors.microsoft.permission.profile": "Läsa din profil (namn och e-post)",
  "settings.connectors.microsoft.connect": "Anslut Microsoft",
  "settings.connectors.microsoft.disconnect": "Koppla från",
  "settings.connectors.microsoft.cancel": "Avbryt",
  "settings.connectors.microsoft.openBrowser": "Öppna webbläsare",
  "settings.connectors.microsoft.waiting": "Väntar på auktorisering…",
  "settings.connectors.microsoft.code.instructions": "Ange den här koden på",
  "settings.connectors.microsoft.connected.text": "Ansluten via OAuth. Jarvis kan komma åt ditt Microsoft-konto.",
  "settings.connectors.microsoft.error.expired": "Auktoriseringskoden har upphört att gälla. Försök igen.",
  "settings.connectors.microsoft.error.generic": "Kunde inte ansluta till Microsoft. Kontrollera anslutningen och försök igen.",
  "settings.connectors.microsoft.error.denied": "Auktorisering nekad. Du kan försöka igen när du vill.",
  ...
  "settings.desktop.wsl.description": "Kör Jarvis-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för Jarvis",
  ...
  "settings.general.row.appearance.description": "Anpassa hur Jarvis ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om Jarvis följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa Jarviss tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när Jarvis startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av Jarvis.",
