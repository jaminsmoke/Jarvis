export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "Jarvis belum terinstal di distro ini",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis telah terinstal, tetapi tidak dapat dijalankan",
...
"settings.connectors.github.connect": "Hubungkan GitHub",
  ...
  "settings.connectors.google.summary": "Hubungkan akun Google Anda agar Jarvis dapat membaca dan mengelola dokumen Drive Anda.",
  "settings.connectors.google.detail": "Hubungkan akun Google Anda agar Jarvis dapat mengakses Google Drive dan Docs Anda. Anda memberikan otorisasi akses dengan akun Google Anda melalui OAuth - Jarvis tidak pernah melihat kata sandi Anda.",
  "settings.connectors.google.permission.drive": "Membaca file Google Drive Anda",
  "settings.connectors.google.permission.profile": "Membaca profil Anda (nama dan email)",
  "settings.connectors.google.connect": "Hubungkan Google",
  "settings.connectors.google.disconnect": "Putuskan",
  "settings.connectors.google.cancel": "Batal",
  "settings.connectors.google.openBrowser": "Buka browser",
  "settings.connectors.google.waiting": "Menunggu otorisasi…",
  "settings.connectors.google.code.instructions": "Masukkan kode ini di",
  "settings.connectors.google.connected.text": "Terhubung melalui OAuth. Jarvis dapat mengakses akun Google Anda.",
  "settings.connectors.google.error.expired": "Kode otorisasi kedaluwarsa. Coba lagi.",
  "settings.connectors.google.error.generic": "Tidak dapat terhubung ke Google. Periksa koneksi Anda dan coba lagi.",
  "settings.connectors.google.error.denied": "Otorisasi ditolak. Anda dapat mencoba lagi kapan saja.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Hubungkan akun Microsoft Anda agar Jarvis dapat mengakses OneDrive, email, dan profil Anda.",
  "settings.connectors.microsoft.detail": "Hubungkan akun Microsoft Anda agar Jarvis dapat mengakses file OneDrive dan profil Anda. Anda memberikan otorisasi akses dengan akun Microsoft Anda melalui OAuth - Jarvis tidak pernah melihat kata sandi Anda.",
  "settings.connectors.microsoft.permission.files": "Membaca file OneDrive Anda",
  "settings.connectors.microsoft.permission.profile": "Membaca profil Anda (nama dan email)",
  "settings.connectors.microsoft.connect": "Hubungkan Microsoft",
  "settings.connectors.microsoft.disconnect": "Putuskan",
  "settings.connectors.microsoft.cancel": "Batal",
  "settings.connectors.microsoft.openBrowser": "Buka browser",
  "settings.connectors.microsoft.waiting": "Menunggu otorisasi…",
  "settings.connectors.microsoft.code.instructions": "Masukkan kode ini di",
  "settings.connectors.microsoft.connected.text": "Terhubung melalui OAuth. Jarvis dapat mengakses akun Microsoft Anda.",
  "settings.connectors.microsoft.error.expired": "Kode otorisasi kedaluwarsa. Coba lagi.",
  "settings.connectors.microsoft.error.generic": "Tidak dapat terhubung ke Microsoft. Periksa koneksi Anda dan coba lagi.",
  "settings.connectors.microsoft.error.denied": "Otorisasi ditolak. Anda dapat mencoba lagi kapan saja.",
