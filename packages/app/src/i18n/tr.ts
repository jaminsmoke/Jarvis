...
export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "Jarvis bu dağıtımda kurulu değil",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis kurulu ancak çalıştırılamadı",
  ...
  "dialog.model.unpaid.freeModels.title": "Jarvis tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.opencodeZen.line1":
    "Jarvis Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "titlebar.toggleDebugTools": "Hata ayıklama araçlarını aç/kapat",
...
"settings.connectors.github.connect": "GitHub'ı bağla",
  ...
  "settings.connectors.google.summary": "Google hesabınızı bağlayarak Jarvis'in Drive belgelerinizi okumasını ve yönetmesini sağlayın.",
  "settings.connectors.google.detail": "Google hesabınızı bağlayın, böylece Jarvis Google Drive ve Docs'unuza erişebilir. Erişimi kendi Google hesabınızla OAuth üzerinden yetkilendirirsiniz - Jarvis şifrenizi asla görmez.",
  "settings.connectors.google.permission.drive": "Google Drive dosyalarınızı okuma",
  "settings.connectors.google.permission.profile": "Profilinizi okuma (ad ve e-posta)",
  "settings.connectors.google.connect": "Google'ı bağla",
  "settings.connectors.google.disconnect": "Bağlantıyı kes",
  "settings.connectors.google.cancel": "İptal",
  "settings.connectors.google.openBrowser": "Tarayıcıyı aç",
  "settings.connectors.google.waiting": "Yetkilendirme bekleniyor…",
  "settings.connectors.google.code.instructions": "Bu kodu şuraya girin:",
  "settings.connectors.google.connected.text": "OAuth ile bağlandı. Jarvis Google hesabınıza erişebilir.",
  "settings.connectors.google.error.expired": "Yetkilendirme kodunun süresi doldu. Lütfen tekrar deneyin.",
  "settings.connectors.google.error.generic": "Google'a bağlanılamadı. Bağlantınızı kontrol edip tekrar deneyin.",
  "settings.connectors.google.error.denied": "Yetkilendirme reddedildi. İstediğiniz zaman tekrar deneyebilirsiniz.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Microsoft hesabınızı bağlayarak Jarvis'in OneDrive, e-posta ve profilinize erişmesini sağlayın.",
  "settings.connectors.microsoft.detail": "Microsoft hesabınızı bağlayın, böylece Jarvis OneDrive dosyalarınıza ve profilinize erişebilir. Erişimi kendi Microsoft hesabınızla OAuth üzerinden yetkilendirirsiniz - Jarvis şifrenizi asla görmez.",
  "settings.connectors.microsoft.permission.files": "OneDrive dosyalarınızı okuma",
  "settings.connectors.microsoft.permission.profile": "Profilinizi okuma (ad ve e-posta)",
  "settings.connectors.microsoft.connect": "Microsoft'u bağla",
  "settings.connectors.microsoft.disconnect": "Bağlantıyı kes",
  "settings.connectors.microsoft.cancel": "İptal",
  "settings.connectors.microsoft.openBrowser": "Tarayıcıyı aç",
  "settings.connectors.microsoft.waiting": "Yetkilendirme bekleniyor…",
  "settings.connectors.microsoft.code.instructions": "Bu kodu şuraya girin:",
  "settings.connectors.microsoft.connected.text": "OAuth ile bağlandı. Jarvis Microsoft hesabınıza erişebilir.",
  "settings.connectors.microsoft.error.expired": "Yetkilendirme kodunun süresi doldu. Lütfen tekrar deneyin.",
  "settings.connectors.microsoft.error.generic": "Microsoft'a bağlanılamadı. Bağlantınızı kontrol edip tekrar deneyin.",
  "settings.connectors.microsoft.error.denied": "Yetkilendirme reddedildi. İstediğiniz zaman tekrar deneyebilirsiniz.",
