export const dict = {
  ...
  "desktop.menu.documentation": "Jarvis दस्तावेज़",
  ...
  "desktop.menu.ariaLabel": "Jarvis मेन्यू",
  ...
  "desktop.recovery.loadFailed": "Jarvis लोड नहीं हो सका",
  "desktop.recovery.terminated": "Jarvis विंडो अनपेक्षित रूप से बंद हो गई",
  "desktop.recovery.unresponsive": "Jarvis प्रतिसाद नहीं दे रहा है",
  ...
  "desktop.wsl.error.installOpencode": "Jarvis इंस्टॉल नहीं हो सका",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहले ही जोड़ा जा चुका है",
  "desktop.wsl.error.opencodeMissing": "इस डिस्ट्रो में Jarvis इंस्टॉल नहीं है",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis इंस्टॉल है, लेकिन चल नहीं सका",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} में Jarvis इंस्टॉल नहीं है",
  "desktop.wsl.error.updateVersion":
    "Jarvis अपडेट पूरा हो गया, लेकिन {{distro}} अब भी {{installed}} रिपोर्ट कर रहा है; अपेक्षित संस्करण {{expected}} है",
  ...
  "provider.connect.apiKey.description":
    "अपने खाते को कनेक्ट करने के लिए अपनी {{provider}} API कुंजी दर्ज करें और Jarvis में {{provider}} मॉडल का उपयोग करें।",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " अपने खाते को कनेक्ट करने और Jarvis में {{provider}} मॉडल का उपयोग करने के लिए अपना प्राधिकरण कोड प्राप्त करें।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " और अपने खाते को कनेक्ट करने तथा Jarvis में {{provider}} मॉडल का उपयोग करने के लिए नीचे दिया गया कोड दर्ज करें।",
  ...
  "dialog.server.description": "स्विच करें कि यह ऐप किस Jarvis सर्वर से कनेक्ट होता है।",
  ...
  "wsl.onboarding.checkingOpencode": "Jarvis की जाँच हो रही है...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} में Jarvis की जाँच हो रही है...",
  "wsl.onboarding.updatingOpencode": "Jarvis अपडेट हो रहा है...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} में Jarvis अपडेट हो रहा है...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} में Jarvis को अपडेट करें।",
  "wsl.onboarding.updateOpencode": "Jarvis को अपडेट करें",
  "wsl.onboarding.opencodeReadyIn": "Jarvis {{distro}} में तैयार है।",
  "wsl.onboarding.opencodeReady": "Jarvis तैयार है।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} में Jarvis स्थापित करें।",
  "wsl.onboarding.installOpencode": "Jarvis स्थापित करें",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis स्थापित नहीं है",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Jarvis द्वारा WSL सर्वर जोड़ने से पहले WSL (Linux के लिए Windows सबसिस्टम) आवश्यक है",
  "wsl.onboarding.wslUnavailable.title": "WSL अनुपलब्ध है",
  "wsl.onboarding.wslUnavailable.description": "Jarvis इस मशीन पर WSL को सत्यापित नहीं कर सका।",
  "wsl.onboarding.installWsl": "WSL स्थापित करें",
  "wsl.onboarding.windowsRestartRequired":
    "WSL की स्थापना समाप्त करने के लिए Windows को पुनरारंभ करें, फिर Jarvis को फिर से खोलें।",
  ...
  "help.tabs.introduction": "Jarvis Desktop अब टैब पर आधारित है।",
  "help.tabs.sessions":
  ...
  "dialog.usageExceeded.dontShowAgain": "दोबारा न दिखाएँ",
  ...
  "toast.update.description": "Jarvis ({{version}}) का एक नया संस्करण अब इंस्टॉल करने के लिए उपलब्ध है।",
  ...
  "error.page.report.prefix": "कृपया इस त्रुटि की रिपोर्ट Jarvis टीम को करें",
  ...
  "error.chain.mcpFailed":
    'MCP सर्वर "{{name}}" विफल रहा। ध्यान दें, Jarvis अभी तक MCP प्रमाणीकरण का समर्थन नहीं करता है।',
  ...
  "titlebar.toggleDebugTools": "डीबग टूल चालू/बंद करें",
  ...
  "sidebar.gettingStarted.line1": "Jarvis में निःशुल्क मॉडल शामिल है ताकि आप तुरंत शुरू कर सकें।",
  ...
  "settings.tab.integrations": "एकीकरण",
  "settings.tab.connectors": "कनेक्टर",
  "settings.integrations.placeholder": "एकीकरण Jarvis रनटाइम का विस्तार करते हैं। जल्द ही आप प्लगइन, थीम और सिस्टम एक्सटेंशन इंस्टॉल कर पाएंगे।",
  "settings.connectors.placeholder": "कनेक्टर Jarvis को बाहरी सेवाओं से जोड़ते हैं। जल्द आ रहे हैं: Gmail, WhatsApp, Slack, Notion, Telegram और अन्य।",
  "settings.connectors.unavailable": "कनेक्टर केवल डेस्कटॉप ऐप में उपलब्ध हैं।",
  "settings.connectors.badge.connected": "कनेक्टेड",
  "settings.connectors.badge.notConnected": "कनेक्टेड नहीं",
  "settings.connectors.badge.disabled": "अक्षम",
  ...
  "settings.connectors.github.summary": "अपने GitHub खाते को कनेक्ट करें ताकि Jarvis आपके रिपॉज़िटरी को पढ़ और प्रबंधित कर सके।",
  "settings.connectors.github.detail": "अपने GitHub खाते को कनेक्ट करें ताकि Jarvis आपके रिपॉज़िटरी, issues और pull requests के साथ सीधे चैट से काम कर सके। आप OAuth के माध्यम से अपने GitHub खाते से एक्सेस अधिकृत करते हैं — Jarvis आपका पासवर्ड कभी नहीं देखता।",
  "settings.connectors.github.permission.repos": "अपने रिपॉज़िटरी, issues और pull requests पढ़ें और प्रबंधित करें",
  "settings.connectors.github.permission.profile": "अपनी सार्वजनिक प्रोफ़ाइल पढ़ें (उपयोगकर्ता नाम और अवतार)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "GitHub कनेक्ट करें",
  "settings.connectors.github.disconnect": "डिस्कनेक्ट करें",
  "settings.connectors.github.cancel": "रद्द करें",
  "settings.connectors.github.openBrowser": "ब्राउज़र खोलें",
  "settings.connectors.github.waiting": "प्राधिकरण की प्रतीक्षा…",
  "settings.connectors.github.code.instructions": "यह कोड दर्ज करें",
  "settings.connectors.github.connected.text": "OAuth के माध्यम से कनेक्टेड। Jarvis आपके GitHub खाते तक पहुँच सकता है।",
  "settings.connectors.github.error.expired": "प्राधिकरण कोड समाप्त हो गया है। फिर से प्रयास करें।",
  "settings.connectors.github.error.generic": "GitHub से कनेक्ट नहीं हो सका। अपना कनेक्शन जाँचें और फिर से प्रयास करें।",
  "settings.connectors.github.error.denied": "प्राधिकरण अस्वीकृत। आप कभी भी फिर से प्रयास कर सकते हैं।",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "अपने Google खाते को कनेक्ट करें ताकि Jarvis आपके Drive दस्तावेज़ पढ़ और प्रबंधित कर सके।",
  "settings.connectors.google.detail": "अपने Google खाते को कनेक्ट करें ताकि Jarvis आपके Google Drive और Docs तक पहुँच सके। आप OAuth के माध्यम से अपने Google खाते से एक्सेस अधिकृत करते हैं - Jarvis आपका पासवर्ड कभी नहीं देखता।",
  "settings.connectors.google.permission.drive": "अपनी Google Drive फ़ाइलें पढ़ें",
  "settings.connectors.google.permission.profile": "अपनी प्रोफ़ाइल पढ़ें (नाम और ईमेल)",
  "settings.connectors.google.connect": "Google कनेक्ट करें",
  "settings.connectors.google.disconnect": "डिस्कनेक्ट करें",
  "settings.connectors.google.cancel": "रद्द करें",
  "settings.connectors.google.openBrowser": "ब्राउज़र खोलें",
  "settings.connectors.google.waiting": "प्राधिकरण की प्रतीक्षा…",
  "settings.connectors.google.code.instructions": "यह कोड दर्ज करें",
  "settings.connectors.google.connected.text": "OAuth के माध्यम से कनेक्टेड। Jarvis आपके Google खाते तक पहुँच सकता है।",
  "settings.connectors.google.error.expired": "प्राधिकरण कोड समाप्त हो गया है। फिर से प्रयास करें।",
  "settings.connectors.google.error.generic": "Google से कनेक्ट नहीं हो सका। अपना कनेक्शन जाँचें और फिर से प्रयास करें।",
  "settings.connectors.google.error.denied": "प्राधिकरण अस्वीकृत। आप कभी भी फिर से प्रयास कर सकते हैं।",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "अपने Microsoft खाते को कनेक्ट करें ताकि Jarvis OneDrive, मेल और आपकी प्रोफ़ाइल तक पहुँच सके।",
  "settings.connectors.microsoft.detail": "अपने Microsoft खाते को कनेक्ट करें ताकि Jarvis आपकी OneDrive फ़ाइलों और प्रोफ़ाइल तक पहुँच सके। आप OAuth के माध्यम से अपने Microsoft खाते से एक्सेस अधिकृत करते हैं - Jarvis आपका पासवर्ड कभी नहीं देखता।",
  "settings.connectors.microsoft.permission.files": "अपनी OneDrive फ़ाइलें पढ़ें",
  "settings.connectors.microsoft.permission.profile": "अपनी प्रोफ़ाइल पढ़ें (नाम और ईमेल)",
  "settings.connectors.microsoft.connect": "Microsoft कनेक्ट करें",
  "settings.connectors.microsoft.disconnect": "डिस्कनेक्ट करें",
  "settings.connectors.microsoft.cancel": "रद्द करें",
  "settings.connectors.microsoft.openBrowser": "ब्राउज़र खोलें",
  "settings.connectors.microsoft.waiting": "प्राधिकरण की प्रतीक्षा…",
  "settings.connectors.microsoft.code.instructions": "यह कोड दर्ज करें",
  "settings.connectors.microsoft.connected.text": "OAuth के माध्यम से कनेक्टेड। Jarvis आपके Microsoft खाते तक पहुँच सकता है।",
  "settings.connectors.microsoft.error.expired": "प्राधिकरण कोड समाप्त हो गया है। फिर से प्रयास करें।",
  "settings.connectors.microsoft.error.generic": "Microsoft से कनेक्ट नहीं हो सका। अपना कनेक्शन जाँचें और फिर से प्रयास करें।",
  "settings.connectors.microsoft.error.denied": "प्राधिकरण अस्वीकृत। आप कभी भी फिर से प्रयास कर सकते हैं।",
  "desktop.menu.wiki": "विकि",
  "command.session.export": "सेशन निर्यात करें",
  "command.session.export.description": "पूरे सेशन का ट्रांसक्रिप्ट JSON के रूप में निर्यात करें",
  ...
  "toast.session.export.failed.title": "सेशन निर्यात विफल",
  ...
  "settings.desktop.wsl.description": "Windows पर WSL के अंदर Jarvis सर्वर चलाएँ।",
  ...
  "settings.general.row.language.description": "Jarvis के लिए प्रदर्शन भाषा बदलें",
  ...
  "settings.general.row.appearance.description": "अनुकूलित करें कि Jarvis आपके डिवाइस पर कैसा दिखता है",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description": "चुनें कि Jarvis सिस्टम, हल्की या गहरी थीम में से किसका उपयोग करे",
  "settings.general.row.theme.title": "थीम",
  "settings.general.row.theme.description": "अनुकूलित करें कि Jarvis की थीम कैसी है।",
  ...
  "settings.updates.row.startup.description": "Jarvis लॉन्च होने पर अपने-आप अपडेट की जाँच करें",
  ...
  "settings.updates.toast.latest.description": "आप Jarvis का नवीनतम संस्करण चला रहे हैं।",
