export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل Jarvis",
  "desktop.recovery.terminated": "توقفت نافذة Jarvis بشكل غير متوقع",
  "desktop.recovery.unresponsive": "Jarvis لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت Jarvis",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.opencodeMissing": "Jarvis غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.opencodeNotInstalled": "Jarvis غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث Jarvis، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "command.session.export.description": "تصدير نص الجلسة الكامل كملف JSON",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في Jarvis.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في Jarvis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في Jarvis.",
  ...
  "dialog.server.description": "تبديل خادم Jarvis الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من Jarvis في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث Jarvis...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث Jarvis في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث Jarvis في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث Jarvis",
  "wsl.onboarding.opencodeReadyIn": "Jarvis جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "Jarvis جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت Jarvis في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "Jarvis غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن Jarvis من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على Jarvis التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح Jarvis.",
  ...
  "help.tabs.introduction": "أصبح Jarvis Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من Jarvis ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق Jarvis",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن Jarvis لا يدعم مصادقة MCP بعد.',
  ...
  "titlebar.toggleDebugTools": "تبديل أدوات التصحيح",
  ...
  "sidebar.gettingStarted.line1": "يتضمن Jarvis نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.tab.connectors": "الموصلات",
  "settings.integrations.placeholder": "تعمل التكاملات على توسيع بيئة Jarvis. قريباً ستتمكن من تثبيت الإضافات والسمات وامتدادات النظام.",
  "settings.connectors.placeholder": "تربط الموصلات Jarvis بالخدمات الخارجية. قريباً: Gmail وWhatsApp وSlack وNotion وTelegram والمزيد.",
  "settings.connectors.unavailable": "الموصلات متاحة فقط في تطبيق سطح المكتب.",
  ...
  "settings.connectors.github.permission.repos": "قراءة وإدارة مستودعاتك وقضاياك وطلبات السحب",
  "settings.connectors.github.permission.profile": "قراءة ملفك الشخصي العام (اسم المستخدم والصورة الرمزية)",
  "settings.connectors.reconnect": "Reconnect",
"settings.connectors.github.connect": "ربط GitHub",
  "settings.connectors.github.disconnect": "قطع الاتصال",
  "settings.connectors.github.cancel": "إلغاء",
  "settings.connectors.github.openBrowser": "فتح المتصفح",
  "settings.connectors.github.waiting": "في انتظار التفويض…",
  "settings.connectors.github.code.instructions": "أدخل هذا الرمز في",
  "settings.connectors.github.connected.text": "متصل عبر OAuth. يمكن لـ Jarvis الوصول إلى حساب GitHub الخاص بك.",
  "settings.connectors.github.error.expired": "انتهت صلاحية رمز التفويض. حاول مرة أخرى.",
  "settings.connectors.github.error.generic": "تعذّر الاتصال بـ GitHub. تحقق من اتصالك وحاول مرة أخرى.",
  "settings.connectors.github.error.denied": "تم رفض التفويض. يمكنك المحاولة مرة أخرى في أي وقت.",
  "settings.connectors.google.name": "Google",
  "settings.connectors.google.summary": "اربط حساب Google الخاص بك ليتمكن Jarvis من قراءة مستندات Drive وإدارتها.",
  "settings.connectors.google.detail": "اربط حساب Google الخاص بك ليتمكن Jarvis من الوصول إلى Google Drive ومستندات Google Docs. تقوم بالتفويض عبر OAuth بحساب Google الخاص بك - لا يطّلع Jarvis على كلمة مرورك أبداً.",
  "settings.connectors.google.permission.drive": "قراءة ملفاتك على Google Drive",
  "settings.connectors.google.permission.profile": "قراءة ملفك الشخصي (الاسم والبريد الإلكتروني)",
  "settings.connectors.google.connect": "ربط Google",
  "settings.connectors.google.disconnect": "قطع الاتصال",
  "settings.connectors.google.cancel": "إلغاء",
  "settings.connectors.google.openBrowser": "فتح المتصفح",
  "settings.connectors.google.waiting": "في انتظار التفويض…",
  "settings.connectors.google.code.instructions": "أدخل هذا الرمز في",
  "settings.connectors.google.connected.text": "متصل عبر OAuth. يمكن لـ Jarvis الوصول إلى حساب Google الخاص بك.",
  "settings.connectors.google.error.expired": "انتهت صلاحية رمز التفويض. حاول مرة أخرى.",
  "settings.connectors.google.error.generic": "تعذّر الاتصال بـ Google. تحقق من اتصالك وحاول مرة أخرى.",
  "settings.connectors.google.error.denied": "تم رفض التفويض. يمكنك المحاولة مرة أخرى في أي وقت.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "اربط حساب Microsoft الخاص بك ليتمكن Jarvis من الوصول إلى OneDrive والبريد وملفك الشخصي.",
  "settings.connectors.microsoft.detail": "اربط حساب Microsoft الخاص بك ليتمكن Jarvis من الوصول إلى ملفاتك على OneDrive وملفك الشخصي. تقوم بالتفويض عبر OAuth بحساب Microsoft الخاص بك - لا يطّلع Jarvis على كلمة مرورك أبداً.",
  "settings.connectors.microsoft.permission.files": "قراءة ملفاتك على OneDrive",
  "settings.connectors.microsoft.permission.profile": "قراءة ملفك الشخصي (الاسم والبريد الإلكتروني)",
  "settings.connectors.microsoft.connect": "ربط Microsoft",
  "settings.connectors.microsoft.disconnect": "قطع الاتصال",
  "settings.connectors.microsoft.cancel": "إلغاء",
  "settings.connectors.microsoft.openBrowser": "فتح المتصفح",
  "settings.connectors.microsoft.waiting": "في انتظار التفويض…",
  "settings.connectors.microsoft.code.instructions": "أدخل هذا الرمز في",
  "settings.connectors.microsoft.connected.text": "متصل عبر OAuth. يمكن لـ Jarvis الوصول إلى حساب Microsoft الخاص بك.",
  "settings.connectors.microsoft.error.expired": "انتهت صلاحية رمز التفويض. حاول مرة أخرى.",
  "settings.connectors.microsoft.error.generic": "تعذّر الاتصال بـ Microsoft. تحقق من اتصالك وحاول مرة أخرى.",
  "settings.connectors.microsoft.error.denied": "تم رفض التفويض. يمكنك المحاولة مرة أخرى في أي وقت.",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "تكامل WSL",
  "settings.desktop.wsl.description": "تشغيل خادم Jarvis داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ Jarvis",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور Jarvis على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان Jarvis يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة Jarvis.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل Jarvis",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من Jarvis.",
  ...
  "dialog.usageExceeded.dontShowAgain": "عدم إظهارها مرة أخرى",
