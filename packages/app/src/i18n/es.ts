...
"settings.connectors.github.connect": "Conectar GitHub",
  ...
  "settings.connectors.google.summary": "Conecta tu cuenta de Google para que Jarvis lea y gestione tus documentos de Drive.",
  "settings.connectors.google.detail": "Conecta tu cuenta de Google para que Jarvis acceda a tus documentos de Google Drive y Docs. Autorizas el acceso con tu propia cuenta de Google mediante OAuth — Jarvis nunca ve tu contraseña.",
  "settings.connectors.google.permission.drive": "Leer tus archivos de Google Drive",
  "settings.connectors.google.permission.profile": "Leer tu perfil (nombre y correo)",
  ...
  "settings.connectors.google.waiting": "Esperando autorización…",
  "settings.connectors.google.code.instructions": "Introduce este código en",
  "settings.connectors.google.connected.text": "Conectado mediante OAuth. Jarvis puede acceder a tu cuenta de Google.",
  "settings.connectors.google.error.expired": "El código de autorización ha expirado. Inténtalo de nuevo.",
  "settings.connectors.google.error.generic": "No se pudo conectar con Google. Comprueba tu conexión e inténtalo de nuevo.",
  "settings.connectors.google.error.denied": "Autorización denegada. Puedes intentarlo de nuevo cuando quieras.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Conecta tu cuenta de Microsoft para que Jarvis acceda a OneDrive, correo y perfil.",
  "settings.connectors.microsoft.detail": "Conecta tu cuenta de Microsoft para que Jarvis acceda a tus archivos de OneDrive y tu perfil. Autorizas el acceso con tu propia cuenta de Microsoft mediante OAuth — Jarvis nunca ve tu contraseña.",
  "settings.connectors.microsoft.permission.files": "Leer tus archivos de OneDrive",
  "settings.connectors.microsoft.permission.profile": "Leer tu perfil (nombre y correo)",
  ...
  "settings.connectors.microsoft.waiting": "Esperando autorización…",
  "settings.connectors.microsoft.code.instructions": "Introduce este código en",
  "settings.connectors.microsoft.connected.text": "Conectado mediante OAuth. Jarvis puede acceder a tu cuenta de Microsoft.",
  "settings.connectors.microsoft.error.expired": "El código de autorización ha expirado. Inténtalo de nuevo.",
  "settings.connectors.microsoft.error.generic": "No se pudo conectar con Microsoft. Comprueba tu conexión e inténtalo de nuevo.",
  "settings.connectors.microsoft.error.denied": "Autorización denegada. Puedes intentarlo de nuevo cuando quieras.",
