export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "Jarvis chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.opencodeCannotRun": "Jarvis đã được cài đặt nhưng không thể chạy",
  ...
  "titlebar.toggleDebugTools": "Bật/tắt công cụ gỡ lỗi",
...
"settings.connectors.github.connect": "Kết nối GitHub",
  ...
  "settings.connectors.google.summary": "Kết nối tài khoản Google của bạn để Jarvis có thể đọc và quản lý tài liệu Drive của bạn.",
  "settings.connectors.google.detail": "Kết nối tài khoản Google của bạn để Jarvis có thể truy cập Google Drive và Docs của bạn. Bạn ủy quyền truy cập bằng tài khoản Google của mình qua OAuth - Jarvis không bao giờ thấy mật khẩu của bạn.",
  "settings.connectors.google.permission.drive": "Đọc tệp Google Drive của bạn",
  "settings.connectors.google.permission.profile": "Đọc hồ sơ của bạn (tên và email)",
  "settings.connectors.google.connect": "Kết nối Google",
  "settings.connectors.google.disconnect": "Ngắt kết nối",
  "settings.connectors.google.cancel": "Hủy",
  "settings.connectors.google.openBrowser": "Mở trình duyệt",
  "settings.connectors.google.waiting": "Đang chờ ủy quyền…",
  "settings.connectors.google.code.instructions": "Nhập mã này trên",
  "settings.connectors.google.connected.text": "Đã kết nối qua OAuth. Jarvis có thể truy cập tài khoản Google của bạn.",
  "settings.connectors.google.error.expired": "Mã ủy quyền đã hết hạn. Hãy thử lại.",
  "settings.connectors.google.error.generic": "Không thể kết nối với Google. Kiểm tra kết nối của bạn và thử lại.",
  "settings.connectors.google.error.denied": "Ủy quyền bị từ chối. Bạn có thể thử lại bất cứ lúc nào.",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "Kết nối tài khoản Microsoft của bạn để Jarvis có thể truy cập OneDrive, email và hồ sơ của bạn.",
  "settings.connectors.microsoft.detail": "Kết nối tài khoản Microsoft của bạn để Jarvis có thể truy cập tệp OneDrive và hồ sơ của bạn. Bạn ủy quyền truy cập bằng tài khoản Microsoft của mình qua OAuth - Jarvis không bao giờ thấy mật khẩu của bạn.",
  "settings.connectors.microsoft.permission.files": "Đọc tệp OneDrive của bạn",
  "settings.connectors.microsoft.permission.profile": "Đọc hồ sơ của bạn (tên và email)",
  "settings.connectors.microsoft.connect": "Kết nối Microsoft",
  "settings.connectors.microsoft.disconnect": "Ngắt kết nối",
  "settings.connectors.microsoft.cancel": "Hủy",
  "settings.connectors.microsoft.openBrowser": "Mở trình duyệt",
  "settings.connectors.microsoft.waiting": "Đang chờ ủy quyền…",
  "settings.connectors.microsoft.code.instructions": "Nhập mã này trên",
  "settings.connectors.microsoft.connected.text": "Đã kết nối qua OAuth. Jarvis có thể truy cập tài khoản Microsoft của bạn.",
  "settings.connectors.microsoft.error.expired": "Mã ủy quyền đã hết hạn. Hãy thử lại.",
  "settings.connectors.microsoft.error.generic": "Không thể kết nối với Microsoft. Kiểm tra kết nối của bạn và thử lại.",
  "settings.connectors.microsoft.error.denied": "Ủy quyền bị từ chối. Bạn có thể thử lại bất cứ lúc nào.",
