...
export const dict = {
  ...
  "desktop.wsl.error.opencodeMissing": "此发行版中未安装 Jarvis",
  "desktop.wsl.error.opencodeCannotRun": "已安装 Jarvis，但无法运行",
...
"settings.connectors.github.connect": "连接 GitHub",
  ...
  "settings.connectors.google.summary": "连接你的 Google 账户，让 Jarvis 读取和管理你的 Drive 文档。",
  "settings.connectors.google.detail": "连接你的 Google 账户，让 Jarvis 访问你的 Google Drive 和 Docs。你通过 OAuth 使用自己的 Google 账户授权访问 - Jarvis 绝不会看到你的密码。",
  "settings.connectors.google.permission.drive": "读取你的 Google Drive 文件",
  "settings.connectors.google.permission.profile": "读取你的资料（姓名和电子邮件）",
  "settings.connectors.google.connect": "连接 Google",
  "settings.connectors.google.disconnect": "断开连接",
  "settings.connectors.google.cancel": "取消",
  "settings.connectors.google.openBrowser": "打开浏览器",
  "settings.connectors.google.waiting": "等待授权…",
  "settings.connectors.google.code.instructions": "在以下位置输入此代码",
  "settings.connectors.google.connected.text": "已通过 OAuth 连接。Jarvis 可以访问你的 Google 账户。",
  "settings.connectors.google.error.expired": "授权代码已过期，请重试。",
  "settings.connectors.google.error.generic": "无法连接到 Google。请检查连接后重试。",
  "settings.connectors.google.error.denied": "授权被拒绝。你可以随时重试。",
  "settings.connectors.microsoft.name": "Microsoft",
  "settings.connectors.microsoft.summary": "连接你的 Microsoft 账户，让 Jarvis 访问 OneDrive、邮件和你的资料。",
  "settings.connectors.microsoft.detail": "连接你的 Microsoft 账户，让 Jarvis 访问你的 OneDrive 文件和资料。你通过 OAuth 使用自己的 Microsoft 账户授权访问 - Jarvis 绝不会看到你的密码。",
  "settings.connectors.microsoft.permission.files": "读取你的 OneDrive 文件",
  "settings.connectors.microsoft.permission.profile": "读取你的资料（姓名和电子邮件）",
  "settings.connectors.microsoft.connect": "连接 Microsoft",
  "settings.connectors.microsoft.disconnect": "断开连接",
  "settings.connectors.microsoft.cancel": "取消",
  "settings.connectors.microsoft.openBrowser": "打开浏览器",
  "settings.connectors.microsoft.waiting": "等待授权…",
  "settings.connectors.microsoft.code.instructions": "在以下位置输入此代码",
  "settings.connectors.microsoft.connected.text": "已通过 OAuth 连接。Jarvis 可以访问你的 Microsoft 账户。",
  "settings.connectors.microsoft.error.expired": "授权代码已过期，请重试。",
  "settings.connectors.microsoft.error.generic": "无法连接到 Microsoft。请检查连接后重试。",
  "settings.connectors.microsoft.error.denied": "授权被拒绝。你可以随时重试。",
