...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "Jarvis 加载失败",
  "desktop.recovery.terminated": "Jarvis 窗口意外终止",
  "desktop.recovery.unresponsive": "Jarvis 未响应",
  ...
  "desktop.wsl.error.installOpencode": "Jarvis 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 Jarvis",
  "desktop.wsl.error.updateVersion":
    "Jarvis 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 Jarvis 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 Jarvis 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 Jarvis 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 Jarvis 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 Jarvis...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 Jarvis...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 Jarvis 已就绪。",
  "wsl.onboarding.opencodeReady": "Jarvis 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 Jarvis。",
  "wsl.onboarding.installOpencode": "安装 Jarvis",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 Jarvis",
  ...
  "wsl.onboarding.wslNotInstalled.description": "Jarvis 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "Jarvis 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 Jarvis。",
  ...
  "help.tabs.introduction": "Jarvis Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Jarvis 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 Jarvis 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：Jarvis 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "Jarvis 提供免费模型，你可以立即开始使用。",
  ...
  "settings.integrations.placeholder": "集成可扩展 Jarvis 运行时。很快你就可以安装插件、主题和系统扩展。",
  "settings.connectors.placeholder": "连接器将 Jarvis 与外部服务连接起来。即将推出：Gmail、WhatsApp、Slack、Notion、Telegram 等。",
  "settings.connectors.unavailable": "连接器仅在桌面应用中可用。",
  ...
  "settings.connectors.github.permission.repos": "读取和管理你的仓库、问题和拉取请求",
  "settings.connectors.github.permission.profile": "读取你的公开资料（用户名和头像）",
  "settings.connectors.github.connect": "连接 GitHub",
  "settings.connectors.github.disconnect": "断开连接",
  "settings.connectors.github.cancel": "取消",
  "settings.connectors.github.openBrowser": "打开浏览器",
  "settings.connectors.github.waiting": "等待授权…",
  "settings.connectors.github.code.instructions": "在以下位置输入此代码",
  "settings.connectors.github.connected.text": "已通过 OAuth 连接。Jarvis 可以访问你的 GitHub 账户。",
  "settings.connectors.github.error.expired": "授权代码已过期，请重试。",
  "settings.connectors.github.error.generic": "无法连接到 GitHub。请检查连接后重试。",
  "settings.connectors.github.error.denied": "授权被拒绝。你可以随时重试。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 Jarvis 服务器。",
  ...
  "settings.general.row.language.description": "更改 Jarvis 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 Jarvis 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 Jarvis 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 Jarvis 的主题。",
  ...
  "settings.updates.row.startup.description": "在 Jarvis 启动时自动检查更新",
