...
import type { DeviceFlowPoll, GitHubConnectorPlatform, GitHubConnectorStatus } from "./types"
...
const platform: { value: { platform: string; connector?: { github: GitHubConnectorPlatform }; fetch?: FetchLike } } = {
  value: { platform: "web" },
}
